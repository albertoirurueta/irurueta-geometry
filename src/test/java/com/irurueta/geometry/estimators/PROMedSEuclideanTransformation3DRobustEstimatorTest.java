...
public class PROMedSEuclideanTransformation3DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(PROMedSEuclideanTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
        ...
        assertEquals(PROMedSEuclideanTransformation3DRobustEstimator.
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final PROMedSEuclideanTransformation3DRobustEstimator estimator =
                new PROMedSEuclideanTransformation3DRobustEstimator();
