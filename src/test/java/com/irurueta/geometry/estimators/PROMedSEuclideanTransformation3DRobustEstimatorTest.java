...
class PROMedSEuclideanTransformation3DRobustEstimatorTest implements EuclideanTransformation3DRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSEuclideanTransformation3DRobustEstimator();

        assertEquals(PROMedSEuclideanTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(PROMedSEuclideanTransformation3DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        assertEquals(PROMedSEuclideanTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROMedSEuclideanTransformation3DRobustEstimator(
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(this, inputPoints, outputPoints);
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(qualityScores);
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(inputPoints, outputPoints, qualityScores);
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(this, qualityScores);
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        // test constructor with listener
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(this, true);
        ...
        // test constructor with listener and points
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(this, inputPoints2, outputPoints2,
                true);
        ...
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(qualityScores2, true);
        ...
        // test constructor with points and quality scores
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(inputPoints2, outputPoints2, qualityScores2,
                true);
        ...
        // test constructor with listener and quality scores
        estimator = new PROMedSEuclideanTransformation3DRobustEstimator(this, qualityScores2,
                true);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSEuclideanTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSEuclideanTransformation3DRobustEstimator(this, inputPoints,
    ...
    public void onEstimateStart(final EuclideanTransformation3DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROMedSEuclideanTransformation3DRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROMedSEuclideanTransformation3DRobustEstimator estimator) {
