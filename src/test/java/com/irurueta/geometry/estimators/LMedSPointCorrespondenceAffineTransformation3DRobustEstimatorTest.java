...
class LMedSPointCorrespondenceAffineTransformation3DRobustEstimatorTest
    ...
    @Test
    void testConstants() {
        assertEquals(1.0, LMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                0.0);
        assertEquals(0.0, LMedSPointCorrespondenceAffineTransformation3DRobustEstimator.MIN_STOP_THRESHOLD,
                0.0);
    }
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator();

        assertEquals(LMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(LMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(LMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this);
        ...
        estimator = new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, inputPoints,
                        pointsEmpty));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this,
    ...
    private static void checkLocked(final LMedSPointCorrespondenceAffineTransformation3DRobustEstimator estimator) {
