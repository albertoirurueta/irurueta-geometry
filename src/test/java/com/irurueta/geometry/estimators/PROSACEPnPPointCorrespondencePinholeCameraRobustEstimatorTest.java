...
public class PROSACEPnPPointCorrespondencePinholeCameraRobustEstimatorTest
    ...
    public void testConstructor() {
        ...
        PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator estimator =
                new PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator();
        ...
        estimator = new PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator(
                points3D, points2D);
        ...
        try {
            // not enough scores
            estimator = new PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator(
                    intrinsic, points3D, points2D, shortQualityScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        try {
            estimator = new PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator(
                    this, intrinsic, shortQualityScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        try {
            // not enough scores
            estimator = new PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator(
                    this, intrinsic, points3D, points2D, shortQualityScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testIsSetComputeAndKeepInliersEnabled() throws LockedException {
        final PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator estimator =
                new PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator();
    ...
    public void testGetSetPoints() throws LockedException {
        ...
        final List<Point2D> points2D = new ArrayList<>();
        for (int i = 0;
             i < PointCorrespondencePinholeCameraRobustEstimator.MIN_NUMBER_OF_POINT_CORRESPONDENCES; i++) {
            points3D.add(Point3D.create());
            points2D.add(Point2D.create());
        }
