...
class RANSACDLTPointCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.MIN_THRESHOLD, 0.0);
        assertFalse(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator();

        assertEquals(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        assertEquals(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        estimator = new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator(
        ...
        estimator = new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D);
    ...
    void testIsSetComputeAndKeepInliersEnabled() throws LockedException {
        final var estimator = new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator();
        ...
        estimator.setComputeAndKeepInliersEnabled(
                !RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
    ...
    void testIsSetComputeAndKeepResidualsEnabled() throws LockedException {
        ...
        estimator.setComputeAndKeepResidualsEnabled(
                !RANSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    void testEstimateWithoutRefinement() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACDLTPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
                    points2DWithError);
            ...
            assertEquals(verticalPrincipalPoint, estimatedIntrinsic.getVerticalPrincipalPoint(),
                    10.0 * LARGE_ABSOLUTE_ERROR);
            assertEquals(skewness, estimatedIntrinsic.getSkewness(), 10.0 * LARGE_ABSOLUTE_ERROR);
    ...
    private static void checkLocked(final RANSACDLTPointCorrespondencePinholeCameraRobustEstimator estimator) {
        final var points3D = new ArrayList<Point3D>();
        final var points2D = new ArrayList<Point2D>();
