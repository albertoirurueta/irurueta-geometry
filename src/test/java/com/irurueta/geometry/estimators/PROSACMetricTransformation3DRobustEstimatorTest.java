...
class PROSACMetricTransformation3DRobustEstimatorTest implements MetricTransformation3DRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, PROSACMetricTransformation3DRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, PROSACMetricTransformation3DRobustEstimator.MIN_THRESHOLD, 0.0);
        assertFalse(PROSACMetricTransformation3DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(PROSACMetricTransformation3DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new PROSACMetricTransformation3DRobustEstimator();

        assertEquals(PROSACMetricTransformation3DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(PROSACMetricTransformation3DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        assertEquals(PROSACMetricTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation3DRobustEstimator(
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(this, inputPoints, outputPoints);
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(qualityScores);
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(inputPoints, outputPoints, qualityScores);
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(this, qualityScores);
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation3DRobustEstimator(this,
                pointsEmpty, pointsEmpty, true));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation3DRobustEstimator(this,
                inputPoints, pointsEmpty, true));
        ...
        estimator = new PROSACMetricTransformation3DRobustEstimator(qualityScores2, true);
        ...
        // test constructor with points and quality scores
        estimator = new PROSACMetricTransformation3DRobustEstimator(inputPoints2, outputPoints2, qualityScores2,
                true);
        ...
        // test constructor with listener and quality scores
        estimator = new PROSACMetricTransformation3DRobustEstimator(this, qualityScores2,
                true);
        ...
        // test constructor with listener, points and quality scores
        estimator = new PROSACMetricTransformation3DRobustEstimator(this, inputPoints2, outputPoints2,
                qualityScores2, true);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROSACMetricTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACMetricTransformation3DRobustEstimator(this, inputPoints,
    ...
    public void onEstimateStart(final MetricTransformation3DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROSACMetricTransformation3DRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROSACMetricTransformation3DRobustEstimator estimator) {
