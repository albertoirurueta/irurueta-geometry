...
class MSACLineCorrespondenceAffineTransformation2DRobustEstimatorTest
    ...
    @Test
    void testConstants() {
        assertEquals(1e-6, MSACLineCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, MSACLineCorrespondenceAffineTransformation2DRobustEstimator.MIN_THRESHOLD,
                0.0);
    }
    ...
    void testConstructor() {
        ...
        var estimator = new MSACLineCorrespondenceAffineTransformation2DRobustEstimator();

        assertEquals(MSACLineCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(MSACLineCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(MSACLineCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(inputLines, outputLines);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(linesEmpty, linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(inputLines, linesEmpty));

        // test constructor with listener
        estimator = new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(this);
        ...
        estimator = new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(this, inputLines,
                outputLines);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(this, linesEmpty,
                        linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(this, inputLines,
                        linesEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACLineCorrespondenceAffineTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACLineCorrespondenceAffineTransformation2DRobustEstimator(this,
    ...
    private static void checkLocked(final MSACLineCorrespondenceAffineTransformation2DRobustEstimator estimator) {
