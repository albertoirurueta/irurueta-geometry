...
class LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator();
        ...
        estimator = new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this);
        ...
        estimator = new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this, inputPoints,
                        pointsEmpty));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this,
    ...
    private static void checkLocked(final LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator estimator) {
