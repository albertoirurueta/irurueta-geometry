...
class MSACLine2DRobustEstimatorTest implements Line2DRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new MSACLine2DRobustEstimator();

        // check correctness
        assertEquals(MSACLine2DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACLine2DRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACLine2DRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACLine2DRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACLine2DRobustEstimator(this, pointsWithError);
    ...
    private static void checkLocked(final MSACLine2DRobustEstimator estimator) {
