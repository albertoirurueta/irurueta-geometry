...
public class MSACLine2DRobustEstimatorTest implements 
    ...
    public MSACLine2DRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        MSACLine2DRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new MSACLine2DRobustEstimator();
    ...
    public void onEstimateStart(Line2DRobustEstimator estimator) {
        estimateStart++;
        testLocked((MSACLine2DRobustEstimator)estimator);
    }
    ...
    private void testLocked(MSACLine2DRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
