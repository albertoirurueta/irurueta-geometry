...
class RANSACEuclideanTransformation2DRobustEstimatorTest implements EuclideanTransformation2DRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACEuclideanTransformation2DRobustEstimator();

        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        ...
        estimator = new RANSACEuclideanTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new RANSACEuclideanTransformation2DRobustEstimator(
        ...
        estimator = new RANSACEuclideanTransformation2DRobustEstimator(this, inputPoints, outputPoints);
        ...
        estimator = new RANSACEuclideanTransformation2DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        // test constructor with listener
        estimator = new RANSACEuclideanTransformation2DRobustEstimator(this, true);
        ...
        // test constructor with listener and points
        estimator = new RANSACEuclideanTransformation2DRobustEstimator(this, inputPoints2, outputPoints2,
                true);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new RANSACEuclideanTransformation2DRobustEstimator();
    ...
    void testGetSetPointsAndIsReady() throws LockedException {
        ...
        final var inputPoints = new ArrayList<Point2D>();
        final var outputPoints = new ArrayList<Point2D>();
        for (var i = 0; i < RANSACEuclideanTransformation2DRobustEstimator.MINIMUM_SIZE; i++) {
            inputPoints.add(Point2D.create());
            outputPoints.add(Point2D.create());
        }
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACEuclideanTransformation2DRobustEstimator(this, inputPoints,
    ...
    public void onEstimateStart(final EuclideanTransformation2DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((RANSACEuclideanTransformation2DRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final RANSACEuclideanTransformation2DRobustEstimator estimator) {
