...
public class RANSACEuclideanTransformation2DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.DEFAULT_CONFIDENCE,
        ...
        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.
                        DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(RANSACEuclideanTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS,
                estimator.getMaxIterations());
