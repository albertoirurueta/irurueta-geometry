...
public class LMedSConicRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        // check correctness
        assertEquals(LMedSConicRobustEstimator.DEFAULT_STOP_THRESHOLD,
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSConicRobustEstimator estimator = new LMedSConicRobustEstimator();
    ...
    public void testEstimate() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSConicRobustEstimator estimator =
    ...
    private void checkLocked(final LMedSConicRobustEstimator estimator) {
        try {
            estimator.setStopThreshold(0.5);
