...
class LMedSConicRobustEstimatorTest implements ConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSConicRobustEstimator();

        // check correctness
        assertEquals(LMedSConicRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSConicRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSConicRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSConicRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSConicRobustEstimator(this, pointsWithError);
    ...
    private static void checkLocked(final LMedSConicRobustEstimator estimator) {
