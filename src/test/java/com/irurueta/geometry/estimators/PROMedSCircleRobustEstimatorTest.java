...
public class PROMedSCircleRobustEstimatorTest implements 
    ...
    public PROMedSCircleRobustEstimatorTest() {}
...
@Test
    public void testConstructor(){
        PROMedSCircleRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new PROMedSCircleRobustEstimator();
    ...
    public void onEstimateStart(CircleRobustEstimator estimator) {
        estimateStart++;
        testLocked((PROMedSCircleRobustEstimator)estimator);
    }
    ...
    private void testLocked(PROMedSCircleRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
