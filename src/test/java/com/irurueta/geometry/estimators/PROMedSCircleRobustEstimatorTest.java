...
class PROMedSCircleRobustEstimatorTest implements CircleRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSCircleRobustEstimator();

        // check correctness
        assertEquals(PROMedSCircleRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(listener, emptyPoints));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(emptyScores));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(emptyPoints,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(points, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(listener, emptyScores));

        // test constructor with listener, points and quality scores
        estimator = new PROMedSCircleRobustEstimator(listener, points, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(listener, emptyPoints,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSCircleRobustEstimator(listener, points,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROMedSCircleRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < nPoints; i++) {
                ...
                if (randomizer.nextInt(0, 100) < PERCENTAGE_OUTLIER) {
                    ...
                    pointWithError = new HomogeneousPoint2D(
                            point.getInhomX() + errorX, point.getInhomY() + errorY, 1.0);
            ...
            final var estimator = new PROMedSCircleRobustEstimator(this, pointsWithError, qualityScores);
    ...
    private static void checkLocked(final PROMedSCircleRobustEstimator estimator) {
