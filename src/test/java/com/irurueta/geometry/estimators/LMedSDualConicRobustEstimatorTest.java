 ...
 * com.irureuta.geometry.estimators.LMedSDualConicRobustEstimator
 * 
...
public class LMedSDualConicRobustEstimatorTest implements 
    ...
    public LMedSDualConicRobustEstimatorTest() {}
    ...
    public void onEstimateStart(DualConicRobustEstimator estimator) {
        estimateStart++;
        testLocked((LMedSDualConicRobustEstimator)estimator);
    }
    ...
    private void testLocked(LMedSDualConicRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
