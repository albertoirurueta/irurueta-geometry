...
public class MSACPoint2DRobustEstimatorTest implements 
    ...
    public MSACPoint2DRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        MSACPoint2DRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new MSACPoint2DRobustEstimator();
        ...
        //check correctness
        assertEquals(estimator.getThreshold(),
                MSACPoint2DRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(estimator.getMethod(), RobustEstimatorMethod.MSAC);
        assertNull(estimator.getListener());
        assertFalse(estimator.isListenerAvailable());
        assertFalse(estimator.isLocked());
    ...
    public void onEstimateStart(Point2DRobustEstimator estimator) {
        estimateStart++;
        testLocked((MSACPoint2DRobustEstimator)estimator);
    }
    ...
    private void testLocked(MSACPoint2DRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
