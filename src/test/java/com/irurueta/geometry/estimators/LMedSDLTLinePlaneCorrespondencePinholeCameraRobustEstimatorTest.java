...
class LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    private static final double STOP_THRESHOLD = 1e-5;
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator();

        assertEquals(LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planesEmpty, linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, linesEmpty));

        // test constructor with listener
        estimator = new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes, lines);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planesEmpty,
                        linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes,
                        linesEmpty));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this,
    ...
    void testEstimateSuggestedVerticalFocalLengthWithRefinement() throws IllegalArgumentException, LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimatedIntrinsicNoSuggestion = estimatedCameraNoSuggestion.getIntrinsicParameters();
            final var estimatedVerticalFocalLengthNoSuggestion = estimatedIntrinsicNoSuggestion.getVerticalFocalLength();
    ...
    void testEstimateSuggestedRotationEnabled() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var intrinsic = new PinholeCameraIntrinsicParameters(horizontalFocalLength,
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final LMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator estimator) {
        final var planes = new ArrayList<Plane>();
        final var lines = new ArrayList<Line2D>();
