...
class MSACMetricTransformation2DRobustEstimatorTest implements MetricTransformation2DRobustEstimatorListener {
    ...
    @Test
    void testConstant() {
        assertEquals(1.0, MSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, MSACMetricTransformation2DRobustEstimator.MIN_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new MSACMetricTransformation2DRobustEstimator();

        assertEquals(MSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(MSACMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(), 0.0);
        assertEquals(MSACMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        ...
        estimator = new MSACMetricTransformation2DRobustEstimator(inputPoints, outputPoints);

        assertEquals(MSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(MSACMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        assertEquals(MSACMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        assertEquals(RobustEstimatorMethod.MSAC, estimator.getMethod());
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new MSACMetricTransformation2DRobustEstimator(pointsEmpty,
                pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new MSACMetricTransformation2DRobustEstimator(inputPoints,
                pointsEmpty));
        ...
        estimator = new MSACMetricTransformation2DRobustEstimator(this, inputPoints, outputPoints);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new MSACMetricTransformation2DRobustEstimator(this,
        ...
        estimator = new MSACMetricTransformation2DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACMetricTransformation2DRobustEstimator(pointsEmpty,
                pointsEmpty, true));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new MSACMetricTransformation2DRobustEstimator(inputPoints2,
                pointsEmpty, true));
        ...
        // test constructor with listener and points
        estimator = new MSACMetricTransformation2DRobustEstimator(this, inputPoints2, outputPoints2,
                true);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new MSACMetricTransformation2DRobustEstimator(
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACMetricTransformation2DRobustEstimator();
    ...
    void testGetSetPointsAndIsReady() throws LockedException {
        ...
        final var inputPoints = new ArrayList<Point2D>();
        final var outputPoints = new ArrayList<Point2D>();
        for (var i = 0; i < MSACMetricTransformation2DRobustEstimator.MINIMUM_SIZE; i++) {
            inputPoints.add(Point2D.create());
            outputPoints.add(Point2D.create());
        }
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var estimator = new MSACMetricTransformation2DRobustEstimator(this, inputPoints,
    ...
    public void onEstimateStart(final MetricTransformation2DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((MSACMetricTransformation2DRobustEstimator) estimator);
    }
    ...
    private void checkLocked(final MSACMetricTransformation2DRobustEstimator estimator) {
