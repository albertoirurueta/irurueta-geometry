...
class PROSACPointCorrespondenceAffineTransformation2DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator();
        ...
        estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this);
        ...
        estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, inputPoints,
                        pointsEmpty));
        ...
        estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(shortQualityScores));
        ...
        //not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, outputPoints,
                        shortQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this,
                        shortQualityScores));
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        final var estimator = new PROSACPointCorrespondenceAffineTransformation2DRobustEstimator(this,
    ...
    private static void checkLocked(final PROSACPointCorrespondenceAffineTransformation2DRobustEstimator estimator) {
