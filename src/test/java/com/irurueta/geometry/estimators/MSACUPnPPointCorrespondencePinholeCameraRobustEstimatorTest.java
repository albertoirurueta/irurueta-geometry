...
class MSACUPnPPointCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstants() {
        assertEquals(1.0, MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.MIN_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator();

        assertEquals(MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator(
        ...
        estimator = new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator();
    ...
    void testIsSetSuggestCenterEnabled() throws LockedException {
        ...
        // check default value
        assertEquals(MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_SUGGEST_CENTER_ENABLED,
                estimator.isSuggestCenterEnabled());

        // set new value
        estimator.setSuggestCenterEnabled(
                !MSACUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_SUGGEST_CENTER_ENABLED);
    ...
    void testEstimateGeneralNoSuggestion() throws LockedException, NotReadyException, CameraException,
        ...
        for (var t = 0; t < 5 * TIMES; t++) {
            ...
            final var estimator = new MSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
                    points2DWithError);
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((MSACUPnPPointCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final MSACUPnPPointCorrespondencePinholeCameraRobustEstimator estimator) {
        final var points3D = new ArrayList<Point3D>();
        final var points2D = new ArrayList<Point2D>();
