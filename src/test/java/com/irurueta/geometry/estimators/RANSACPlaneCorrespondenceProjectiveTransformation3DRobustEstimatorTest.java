...
class RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimatorTest
    ...
    void testConstants() {
        ...
        assertEquals(1e-6,
                RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.MIN_THRESHOLD,
                0.0);
        assertFalse(
                RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(
                RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator();

        assertEquals(RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(inputPlanes, outputPlanes);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(planesEmpty, planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(inputPlanes, planesEmpty));

        // test constructor with listener
        estimator = new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this);
        ...
        estimator = new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this, inputPlanes,
                outputPlanes);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this, planesEmpty,
                        planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this, inputPlanes,
                        planesEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator();
    ...
    void testGetSetPlanesAndIsReady() throws LockedException {
        ...
        // set new value
        final var inputLines = new ArrayList<Plane>();
        final var outputLines = new ArrayList<Plane>();
        for (var i = 0; i < PlaneCorrespondenceProjectiveTransformation3DRobustEstimator.MINIMUM_SIZE; i++) {
        ...
        // check correctness
        assertSame(inputLines, estimator.getInputPlanes());
        assertSame(outputLines, estimator.getOutputPlanes());
        assertTrue(estimator.isReady());
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        final var estimator = new RANSACPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this,
