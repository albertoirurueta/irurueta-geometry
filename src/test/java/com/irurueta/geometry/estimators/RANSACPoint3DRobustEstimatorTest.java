...
public class RANSACPoint3DRobustEstimatorTest implements 
    ...
    public RANSACPoint3DRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        ...
        estimator = new RANSACPoint3DRobustEstimator();
    ...
    public void onEstimateStart(Point3DRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACPoint3DRobustEstimator)estimator);
    }
    ...
    private void testLocked(RANSACPoint3DRobustEstimator estimator){
        try {
            estimator.setThreshold(0.5);
