...
class RANSACPoint2DRobustEstimatorTest implements Point2DRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, RANSACPoint2DRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, RANSACPoint2DRobustEstimator.MIN_THRESHOLD, 0.0);
        assertFalse(RANSACPoint2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(RANSACPoint2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new RANSACPoint2DRobustEstimator();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACPoint2DRobustEstimator(emptyLines));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACPoint2DRobustEstimator(listener, emptyLines));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACPoint2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var estimator = new RANSACPoint2DRobustEstimator(this, linesWithError);
    ...
    public void onEstimateStart(final Point2DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((RANSACPoint2DRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final RANSACPoint2DRobustEstimator estimator) {
