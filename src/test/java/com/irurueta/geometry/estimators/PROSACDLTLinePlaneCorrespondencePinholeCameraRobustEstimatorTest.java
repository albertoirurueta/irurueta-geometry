...
class PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1e-6, PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.MIN_THRESHOLD,
                0.0);
        assertFalse(PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator();
        ...
        estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planesEmpty, linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, linesEmpty));

        // test constructor with listener
        estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes, lines);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planesEmpty,
                        linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes,
                        linesEmpty));
        ...
        estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(shortQualityScores));

        // test constructor with lines and planes and quality scores
        estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines, qualityScores);
        ...
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines,
                        shortQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this,
                        shortQualityScores));
        ...
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes, linesEmpty,
                        qualityScores));
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes, lines,
                        shortQualityScores));
    }

    @Test
    void testIsSetComputeAndKeepInliersEnabled() throws LockedException {
        final var estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var qualityScores = new double[nSamples];
            var j = 0;
            ...
            final var estimator = new PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this,
                    planesWithError, lines, qualityScores);
    ...
    void testEstimateSuggestedAspectRatioEnabled() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var planesWithError = new ArrayList<Plane>();
            final var errorRandomizer = new GaussianRandomizer(0.0, STD_ERROR);
            final double[] qualityScores = new double[nSamples];
            var j = 0;
            for (final var plane : planes) {
                final var scoreError = randomizer.nextDouble(MIN_SCORE_ERROR, MAX_SCORE_ERROR);
                qualityScores[j] = 1.0 + scoreError;
    ...
    void testEstimateZeroSkewnessZeroPrincipalPointAndEqualFocalLengthWithFastRefinement()
            throws IllegalArgumentException, LockedException, NotReadyException, CameraException, NotAvailableException {
        var numCovariances = 0;
        var numValid = 0;
        for (var t = 0; t < 5 * TIMES; t++) {
            final var randomizer = new UniformRandomizer();
    ...
    private static void checkLocked(final PROSACDLTLinePlaneCorrespondencePinholeCameraRobustEstimator estimator) {
        final var planes = new ArrayList<Plane>();
        final var lines = new ArrayList<Line2D>();
