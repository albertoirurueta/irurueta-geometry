...
class PROMedSEuclideanTransformation2DRobustEstimatorTest implements EuclideanTransformation2DRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, PROMedSEuclideanTransformation2DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, PROMedSEuclideanTransformation2DRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }
