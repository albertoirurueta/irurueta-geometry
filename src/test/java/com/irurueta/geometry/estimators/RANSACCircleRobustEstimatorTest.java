 ...
 * com.irurueta.geometry.estimators.RANSACCircleRobustEstimator
 * 
...
public class RANSACCircleRobustEstimatorTest implements 
    ...
    public RANSACCircleRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        RANSACCircleRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new RANSACCircleRobustEstimator();
        ...
        estimator = null;
        try{
            estimator = new RANSACCircleRobustEstimator(emptyPoints);
        ...
        estimator = null;
        try{
            estimator = new RANSACCircleRobustEstimator(listener, emptyPoints);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
        assertNull(estimator);        
    }
    ...
    public void testEstimate() throws LockedException, NotReadyException, 
        ...
        for(int t = 0; t < TIMES; t++){
            ...
            RANSACCircleRobustEstimator estimator = 
                    new RANSACCircleRobustEstimator(this, pointsWithError);
    ...
    public void onEstimateStart(CircleRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACCircleRobustEstimator)estimator);
    }
    ...
    private void testLocked(RANSACCircleRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
