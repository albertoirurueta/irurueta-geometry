...
class LMedSMetricTransformation3DRobustEstimatorTest implements MetricTransformation3DRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1.0, LMedSMetricTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSMetricTransformation3DRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new LMedSMetricTransformation3DRobustEstimator();

        assertEquals(LMedSMetricTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        assertEquals(LMedSMetricTransformation3DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        assertEquals(LMedSMetricTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        ...
        estimator = new LMedSMetricTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation3DRobustEstimator(pointsEmpty,
                pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation3DRobustEstimator(inputPoints,
                pointsEmpty));
        ...
        estimator = new LMedSMetricTransformation3DRobustEstimator(this, inputPoints, outputPoints);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation3DRobustEstimator(this,
        ...
        estimator = new LMedSMetricTransformation3DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation3DRobustEstimator(
                this, inputPoints, pointsEmpty, true));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSMetricTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSMetricTransformation3DRobustEstimator(this, inputPoints,
            ...
            // that output points are equal to the original output points without error
            for (var i = 0; i < nPoints; i++) {
    ...
    private static void checkLocked(final LMedSMetricTransformation3DRobustEstimator estimator) {
