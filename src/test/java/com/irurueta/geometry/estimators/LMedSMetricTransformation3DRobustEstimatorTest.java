...
public class LMedSMetricTransformation3DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(LMedSMetricTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(LMedSMetricTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(LMedSMetricTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSMetricTransformation3DRobustEstimator estimator =
                new LMedSMetricTransformation3DRobustEstimator();
