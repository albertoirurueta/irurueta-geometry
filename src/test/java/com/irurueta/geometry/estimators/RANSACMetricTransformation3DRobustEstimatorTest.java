...
public class RANSACMetricTransformation3DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(RANSACMetricTransformation3DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RANSACMetricTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(RANSACMetricTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
