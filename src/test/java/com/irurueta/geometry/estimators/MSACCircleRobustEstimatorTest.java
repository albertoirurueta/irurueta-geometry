...
public class MSACCircleRobustEstimatorTest implements 
    ...
    public MSACCircleRobustEstimatorTest() {}
...
@Test
    public void testConstructor(){
        MSACCircleRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new MSACCircleRobustEstimator();
    ...
    public void onEstimateStart(CircleRobustEstimator estimator) {
        estimateStart++;
        testLocked((MSACCircleRobustEstimator)estimator);
    }
    ...
    private void testLocked(MSACCircleRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
