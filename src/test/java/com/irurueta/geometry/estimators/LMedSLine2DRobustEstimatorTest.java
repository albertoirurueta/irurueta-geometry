...
class LMedSLine2DRobustEstimatorTest implements Line2DRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1e-3, LMedSLine2DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSLine2DRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new LMedSLine2DRobustEstimator();

        // check correctness
        assertEquals(LMedSLine2DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSLine2DRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSLine2DRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new LMedSLine2DRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSLine2DRobustEstimator(this, pointsWithError);
    ...
    private static void checkLocked(final LMedSLine2DRobustEstimator estimator) {
