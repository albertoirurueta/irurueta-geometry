...
public class LMedSLine2DRobustEstimatorTest implements 
    ...
    public LMedSLine2DRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        LMedSLine2DRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new LMedSLine2DRobustEstimator();
        
        //check correctness
        assertEquals(estimator.getStopThreshold(),
                LMedSLine2DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void onEstimateStart(Line2DRobustEstimator estimator) {
        estimateStart++;
        testLocked((LMedSLine2DRobustEstimator)estimator);
    }
    ...
    private void testLocked(LMedSLine2DRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
