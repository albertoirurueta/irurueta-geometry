...
class PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator();

        assertEquals(PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, outputPlanes);
        ...
        final var linesPlane = new ArrayList<Plane>();
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(linesPlane, linesPlane));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, linesPlane));

        // test constructor with listener
        estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this);
        ...
        estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, inputPlanes,
                outputPlanes);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, linesPlane,
                        linesPlane));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, inputPlanes,
                        linesPlane));
        ...
        estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(shortQualityScores));
        ...
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, outputPlanes,
                        shortQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this,
                        shortQualityScores));
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        final var estimator = new PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this,
    ...
    private static void testLocked(final PROSACPlaneCorrespondenceAffineTransformation3DRobustEstimator estimator) {
