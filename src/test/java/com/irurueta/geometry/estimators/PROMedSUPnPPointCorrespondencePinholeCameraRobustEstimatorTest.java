...
class PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_STOP_THRESHOLD,
                0.0);
        assertEquals(0.0, PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.MIN_STOP_THRESHOLD,
                0.0);
    }
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator();

        assertEquals(PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(points3DEmpty, points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2DEmpty));

        // test constructor with listener and points
        estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3DEmpty,
                        points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
                        points2DEmpty));

        // test constructor without arguments
        final var qualityScores = new double[points2D.size()];
        estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(qualityScores);
        ...
        // test constructor with listener
        estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(this, qualityScores);
        ...
        // test constructor with points
        estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D, qualityScores);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        final var qualityScores = new double[
                PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.MIN_NUMBER_OF_POINT_CORRESPONDENCES];
    ...
    void testIsSetSuggestCenterEnabled() throws LockedException {
        ...
        // check default value
        assertEquals(PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_SUGGEST_CENTER_ENABLED,
                estimator.isSuggestCenterEnabled());

        // set new value
        estimator.setSuggestCenterEnabled(
                !PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_SUGGEST_CENTER_ENABLED);
    ...
    void testEstimateGeneralNoSuggestion() throws LockedException, NotReadyException, CameraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROMedSUPnPPointCorrespondencePinholeCameraRobustEstimator estimator) {
        final var points3D = new ArrayList<Point3D>();
        final var points2D = new ArrayList<Point2D>();
