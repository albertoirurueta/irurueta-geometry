...
public class LMedSSphereRobustEstimatorTest implements 
    ...
    public LMedSSphereRobustEstimatorTest() { }
    ...
    public void testConstructor() {
        LMedSSphereRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new LMedSSphereRobustEstimator();
        
        //check correctness
        assertEquals(estimator.getStopThreshold(), 
                LMedSSphereRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        ...
        estimator = null;
        try {
            estimator = new LMedSSphereRobustEstimator(emptyPoints);
        ...
        estimator = null;
        try {
            estimator = new LMedSSphereRobustEstimator(listener, emptyPoints);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(estimator);        
    }
    ...
    public void testGetSetThreshold() throws LockedException {
        LMedSSphereRobustEstimator estimator = 
                new LMedSSphereRobustEstimator();
    ...
    public void testEstimate() throws LockedException, NotReadyException, 
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            LMedSSphereRobustEstimator estimator = 
                    new LMedSSphereRobustEstimator(this, pointsWithError);
    ...
    private void checkLocked(LMedSSphereRobustEstimator estimator){
        try {
            estimator.setStopThreshold(0.5);
