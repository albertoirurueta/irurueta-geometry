...
public class LMedSSphereRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        // check correctness
        assertEquals(LMedSSphereRobustEstimator.DEFAULT_STOP_THRESHOLD,
    ...
    public void testGetSetThreshold() throws LockedException {
        final LMedSSphereRobustEstimator estimator =
    ...
    private void checkLocked(final LMedSSphereRobustEstimator estimator) {
        try {
            estimator.setStopThreshold(0.5);
