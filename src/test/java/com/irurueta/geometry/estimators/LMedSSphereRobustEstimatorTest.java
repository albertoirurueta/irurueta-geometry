...
class LMedSSphereRobustEstimatorTest implements SphereRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1e-3, LMedSSphereRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSSphereRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        //test constructor without arguments
        var estimator = new LMedSSphereRobustEstimator();

        // check correctness
        assertEquals(LMedSSphereRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        estimator = new LMedSSphereRobustEstimator(points);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSSphereRobustEstimator(emptyPoints));
        ...
        estimator = new LMedSSphereRobustEstimator(listener);
        ...
        estimator = new LMedSSphereRobustEstimator(listener, points);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSSphereRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new LMedSSphereRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSSphereRobustEstimator(this, pointsWithError);
    ...
    public void onEstimateStart(final SphereRobustEstimator estimator) {
        estimateStart++;
        checkLocked((LMedSSphereRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final LMedSSphereRobustEstimator estimator) {
