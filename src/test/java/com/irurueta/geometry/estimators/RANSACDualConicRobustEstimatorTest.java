...
public class RANSACDualConicRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        // check correctness
        assertEquals(RANSACDualConicRobustEstimator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACDualConicRobustEstimator estimator =
    ...
    private void checkLocked(final RANSACDualConicRobustEstimator estimator) {
        try {
            estimator.setThreshold(0.5);
