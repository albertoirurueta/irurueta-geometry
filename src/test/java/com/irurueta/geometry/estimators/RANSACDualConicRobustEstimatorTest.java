...
class RANSACDualConicRobustEstimatorTest implements DualConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACDualConicRobustEstimator();

        // check correctness
        assertEquals(RANSACDualConicRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        estimator = new RANSACDualConicRobustEstimator(lines);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACDualConicRobustEstimator(emptyLines));
        ...
        estimator = new RANSACDualConicRobustEstimator(listener);
        ...
        estimator = new RANSACDualConicRobustEstimator(listener, lines);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACDualConicRobustEstimator(listener, emptyLines));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACDualConicRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACDualConicRobustEstimator(this, linesWithError);
    ...
    public void onEstimateStart(final DualConicRobustEstimator estimator) {
        estimateStart++;
        checkLocked((RANSACDualConicRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final RANSACDualConicRobustEstimator estimator) {
