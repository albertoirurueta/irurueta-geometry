...
class RANSACPointCorrespondenceAffineTransformation2DRobustEstimatorTest
    ...
    void testConstants() {
        ...
        assertEquals(1.0, RANSACPointCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, RANSACPointCorrespondenceAffineTransformation2DRobustEstimator.MIN_THRESHOLD,
                0.0);
        assertFalse(RANSACPointCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(RANSACPointCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator();
        ...
        estimator = new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(this);
        ...
        estimator = new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, inputPoints,
                        pointsEmpty));
    }
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        final var estimator = new RANSACPointCorrespondenceAffineTransformation2DRobustEstimator(this,
    ...
    private static void checkLocked(final RANSACPointCorrespondenceAffineTransformation2DRobustEstimator estimator) {
