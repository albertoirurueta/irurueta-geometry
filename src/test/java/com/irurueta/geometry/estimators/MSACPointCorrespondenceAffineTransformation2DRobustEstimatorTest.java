...
class MSACPointCorrespondenceAffineTransformation2DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new MSACPointCorrespondenceAffineTransformation2DRobustEstimator();

        assertEquals(MSACPointCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(MSACPointCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(MSACPointCorrespondenceAffineTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(this);
        ...
        estimator = new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(this, inputPoints,
                        pointsEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACPointCorrespondenceAffineTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACPointCorrespondenceAffineTransformation2DRobustEstimator(this,
    ...
    private static void checkLocked(final MSACPointCorrespondenceAffineTransformation2DRobustEstimator estimator) {
