...
public class PROSACPlaneRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        PROSACPlaneRobustEstimator estimator = new PROSACPlaneRobustEstimator();

        // check correctness
        assertEquals(PROSACPlaneRobustEstimator.DEFAULT_THRESHOLD,
        ...
        // check correctness
        assertEquals(RANSACPlaneRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.PROSAC, estimator.getMethod());
    ...
    public void testGetSetThreshold() throws LockedException {
        final PROSACPlaneRobustEstimator estimator =
    ...
    private void checkLocked(final PROSACPlaneRobustEstimator estimator) {
        try {
            estimator.setThreshold(0.5);
