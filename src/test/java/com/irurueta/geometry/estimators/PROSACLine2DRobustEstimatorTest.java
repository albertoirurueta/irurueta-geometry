...
class PROSACLine2DRobustEstimatorTest implements Line2DRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACLine2DRobustEstimator();

        // check correctness
        assertEquals(PROSACLine2DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(listener, emptyPoints));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(emptyPoints, qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(points, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(listener, emptyScores));

        // test constructor with listener, points and quality scores
        estimator = new PROSACLine2DRobustEstimator(listener, points, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(listener, emptyPoints,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROSACLine2DRobustEstimator(listener, points,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACLine2DRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACLine2DRobustEstimator(this, pointsWithError, qualityScores);
    ...
    private static void checkLocked(final PROSACLine2DRobustEstimator estimator) {
