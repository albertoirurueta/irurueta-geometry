...
class PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator();

        assertEquals(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
        ...
        estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines);

        assertEquals(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.DEFAULT_MAX_ITERATIONS,
                estimator.getMaxIterations());
        assertEquals(RobustEstimatorMethod.PROMEDS, estimator.getMethod());
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planesEmpty, linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, linesEmpty));

        // test constructor with listener
        estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes, lines);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planesEmpty,
                        linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes,
                        linesEmpty));
        ...
        estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(shortQualityScores));

        // test constructor with lines and planes and quality scores
        estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines, qualityScores);
        ...
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(planes, lines,
                        shortQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this,
                        shortQualityScores));
        ...
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this, planes, lines,
                        shortQualityScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator(this,
    ...
    void testEstimateWithFastRefinement() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < 5 * TIMES; t++) {
            ...
            final var estimatedBetaEuler = estimatedRotation2.getBetaEulerAngle();
            final var estimatedGammaEuler = estimatedRotation2.getGammaEulerAngle();
            final boolean validAlphaEuler, validBetaEuler, validGammaEuler;
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator estimator) {
        final var planes = new ArrayList<Plane>();
        final var lines = new ArrayList<Line2D>();
