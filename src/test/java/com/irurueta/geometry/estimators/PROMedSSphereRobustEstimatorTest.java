...
public class PROMedSSphereRobustEstimatorTest implements 
    ...
    public PROMedSSphereRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        PROMedSSphereRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new PROMedSSphereRobustEstimator();
        
        //check correctness
        assertEquals(estimator.getStopThreshold(), 
                PROMedSSphereRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void onEstimateStart(SphereRobustEstimator estimator) {
        estimateStart++;
        testLocked((PROMedSSphereRobustEstimator)estimator);
    }
    ...
    private void testLocked(PROMedSSphereRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
