...
public class RANSACQuadricRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        // check correctness
        assertEquals(RANSACQuadricRobustEstimator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACQuadricRobustEstimator estimator =
    ...
    private void checkLocked(final RANSACQuadricRobustEstimator estimator) {
        try {
            estimator.setThreshold(0.5);
