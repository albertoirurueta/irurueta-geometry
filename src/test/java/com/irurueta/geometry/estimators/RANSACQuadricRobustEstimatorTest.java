...
class RANSACQuadricRobustEstimatorTest implements QuadricRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACQuadricRobustEstimator();
        ...
        estimator = new RANSACQuadricRobustEstimator(points);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACQuadricRobustEstimator(emptyPoints));
        ...
        estimator = new RANSACQuadricRobustEstimator(listener);
        ...
        estimator = new RANSACQuadricRobustEstimator(listener, points);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACQuadricRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACQuadricRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var estimator = new RANSACQuadricRobustEstimator(this, pointsWithError);
    ...
    public void onEstimateStart(final QuadricRobustEstimator estimator) {
        estimateStart++;
        checkLocked((RANSACQuadricRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final RANSACQuadricRobustEstimator estimator) {
