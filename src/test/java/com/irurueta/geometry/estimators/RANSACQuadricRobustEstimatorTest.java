 ...
 * com.irurueta.geometry.estimators.RANSACQuadricRobustEstimator
 * 
...
public class RANSACQuadricRobustEstimatorTest implements 
    ...
    public RANSACQuadricRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        RANSACQuadricRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new RANSACQuadricRobustEstimator();
        ...
        estimator = null;
        try{
            estimator = new RANSACQuadricRobustEstimator(emptyPoints);
        ...
        estimator = null;
        try{
            estimator = new RANSACQuadricRobustEstimator(listener, emptyPoints);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
        assertNull(estimator);        
    }
    ...
    public void testGetSetThreshold() throws LockedException{
        RANSACQuadricRobustEstimator estimator = 
                new RANSACQuadricRobustEstimator();
    ...
    public void testEstimate() throws LockedException, NotReadyException, 
        ...
        for(int t = 0; t < TIMES; t++){
            ...
            RANSACQuadricRobustEstimator estimator = 
                    new RANSACQuadricRobustEstimator(this, pointsWithError);
    ...
    public void onEstimateStart(QuadricRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACQuadricRobustEstimator)estimator);
    }
    ...
    private void testLocked(RANSACQuadricRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
