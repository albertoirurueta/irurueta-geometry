...
class LMedSEuclideanTransformation2DRobustEstimatorTest implements EuclideanTransformation2DRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1.0, LMedSEuclideanTransformation2DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSEuclideanTransformation2DRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new LMedSEuclideanTransformation2DRobustEstimator();
        ...
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new LMedSEuclideanTransformation2DRobustEstimator(
        ...
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(this);
        ...
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(this, inputPoints, outputPoints);
        ...
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(true);
        ...
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        // test constructor with listener
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(this, true);
        ...
        // test constructor with listener and points
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(this, inputPoints2, outputPoints2,
                true);
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSEuclideanTransformation2DRobustEstimator(this, inputPoints,
    ...
    public void onEstimateStart(final EuclideanTransformation2DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((LMedSEuclideanTransformation2DRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final LMedSEuclideanTransformation2DRobustEstimator estimator) {
