...
public class LMedSEuclideanTransformation2DRobustEstimatorTest implements
    ...
    public void testConstants() {
        assertEquals(1.0, LMedSEuclideanTransformation2DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                0.0);
        assertEquals(0.0, LMedSEuclideanTransformation2DRobustEstimator.MIN_STOP_THRESHOLD,
                0.0);
    }
    ...
    public void testConstructor() {
        ...
        estimator = new LMedSEuclideanTransformation2DRobustEstimator(
    ...
    public void testEstimateWithoutRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSEuclideanTransformation2DRobustEstimator estimator =
                    new LMedSEuclideanTransformation2DRobustEstimator(this,
