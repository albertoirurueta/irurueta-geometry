...
class RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimatorTest
    ...
    void testConstants() {
        ...
        assertEquals(RobustEstimatorMethod.PROMEDS,
                RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_ROBUST_METHOD);
        assertEquals(1.0, RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator.MIN_THRESHOLD,
                0.0);
        assertFalse(
                RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(
                RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator();
        ...
        estimator = new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(this);
        ...
        estimator = new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(this, inputPoints,
                        pointsEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        final var estimator = new RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator(this,
    ...
    public void onEstimateStart(final ProjectiveTransformation3DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((RANSACPointCorrespondenceProjectiveTransformation3DRobustEstimator) estimator);
    }
