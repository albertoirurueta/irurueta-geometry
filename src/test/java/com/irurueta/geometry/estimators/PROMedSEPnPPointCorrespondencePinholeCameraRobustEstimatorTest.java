...
class PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator();

        assertEquals(PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(points3DEmpty, points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2DEmpty));

        // test constructor with listener and points
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3DEmpty,
                        points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
                        points2DEmpty));

        // test constructor with intrinsic and listener
        final var intrinsic = new PinholeCameraIntrinsicParameters();

        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic);
        ...
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, intrinsic);
        ...
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, points3DEmpty,
                        points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, points3D,
                        points2DEmpty));

        // test constructor with listener, points and intrinsic
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, intrinsic, points3D,
                points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, intrinsic,
                        points3DEmpty, points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, intrinsic, points3D,
                        points2DEmpty));

        // test constructor without arguments
        final var qualityScores = new double[
                EPnPPointCorrespondencePinholeCameraRobustEstimator.MIN_NUMBER_OF_POINT_CORRESPONDENCES];
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(qualityScores);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(wrongQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, wrongQualityScores));

        // test constructor with points and quality scores
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2DEmpty,
                        qualityScores));
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D,
                        wrongQualityScores));
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
                        points2DEmpty, qualityScores));
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D,
                        wrongQualityScores));

        // test constructor with intrinsic and listener
        estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, wrongQualityScores));
        ...
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, points3D, points2DEmpty,
                        qualityScores));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(intrinsic, points3D, points2D,
                        wrongQualityScores));
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this, intrinsic, points3D,
                        points2D, wrongQualityScores));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        // Force IllegalArgumentException
        final var wrongQualityScores = new double[1];
        assertThrows(IllegalArgumentException.class, () -> estimator.setQualityScores(wrongQualityScores));
    }
    ...
    void testEstimateGeneralNoSuggestion() throws LockedException, NotReadyException, CameraException,
        ...
        for (var t = 0; t < 5 * TIMES; t++) {
            ...
            final var estimator = new PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator(this,
                    intrinsic, points3D, points2DWithError, qualityScores);
    ...
    void testEstimatePlanarSuggestedCenterEnabled() throws LockedException, NotReadyException, CameraException,
        ...
        for (var t = 0; t < 5 * TIMES; t++) {
            ...
            // comparing center
            var estimatedCenter = estimatedCamera.getCameraCenter();
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROMedSEPnPPointCorrespondencePinholeCameraRobustEstimator estimator) {
        final var points3D = new ArrayList<Point3D>();
        final var points2D = new ArrayList<Point2D>();
