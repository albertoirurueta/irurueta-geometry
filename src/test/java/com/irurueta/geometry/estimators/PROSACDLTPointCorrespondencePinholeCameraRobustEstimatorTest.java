...
public class PROSACDLTPointCorrespondencePinholeCameraRobustEstimatorTest 
    ...
    public static final double LARGE_ABSOLUTE_ERROR = 1e-1;
    ...
    public PROSACDLTPointCorrespondencePinholeCameraRobustEstimatorTest() { }
    ...
    public void onEstimateStart(PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        testLocked((PROSACDLTPointCorrespondencePinholeCameraRobustEstimator)estimator);
    }
