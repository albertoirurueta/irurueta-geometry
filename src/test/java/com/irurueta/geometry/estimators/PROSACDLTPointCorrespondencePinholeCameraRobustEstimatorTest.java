...
class PROSACDLTPointCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.MIN_THRESHOLD, 0.0);
        assertFalse(PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator();
        ...
        assertEquals(PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(
        ...
        estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(this);
        ...
        estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D);
        ...
        final var qualityScores = new double[PointCorrespondencePinholeCameraRobustEstimator.
                MIN_NUMBER_OF_POINT_CORRESPONDENCES];
        final var shortQualityScores = new double[1];

        estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(qualityScores);
        ...
        estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D, qualityScores);
        ...
        estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(this, qualityScores);
    ...
    void testIsSetComputeAndKeepInliersEnabled() throws LockedException {
        final var estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator();
        ...
        estimator.setComputeAndKeepInliersEnabled(
                !PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
    ...
    void testIsSetComputeAndKeepResidualsEnabled() throws LockedException {
        ...
        estimator.setComputeAndKeepResidualsEnabled(
                !PROSACDLTPointCorrespondencePinholeCameraRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    void testEstimateWithoutRefinement() throws IllegalArgumentException, LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACDLTPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROSACDLTPointCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private void checkLocked(final PROSACDLTPointCorrespondencePinholeCameraRobustEstimator estimator) {
        final var points3D = new ArrayList<Point3D>();
        final var points2D = new ArrayList<Point2D>();
