...
public class RANSACLine2DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        // check correctness
        assertEquals(RANSACLine2DRobustEstimator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACLine2DRobustEstimator estimator =
    ...
    private void checkLocked(final RANSACLine2DRobustEstimator estimator) {
        try {
            estimator.setThreshold(0.5);
