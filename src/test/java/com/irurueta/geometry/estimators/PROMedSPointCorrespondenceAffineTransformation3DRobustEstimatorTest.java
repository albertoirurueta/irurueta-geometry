...
class PROMedSPointCorrespondenceAffineTransformation3DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator();

        assertEquals(PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this);
        ...
        estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, inputPoints,
                        pointsEmpty));
        ...
        estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(shortQualityScores));
        ...
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, outputPoints,
                        shortQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this,
                        shortQualityScores));
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        final var estimator = new PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator(this,
    ...
    private static void checkLocked(final PROMedSPointCorrespondenceAffineTransformation3DRobustEstimator estimator) {
