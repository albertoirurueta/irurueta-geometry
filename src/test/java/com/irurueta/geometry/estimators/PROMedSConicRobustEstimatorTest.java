...
class PROMedSConicRobustEstimatorTest implements ConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSConicRobustEstimator();

        // check correctness
        assertEquals(PROMedSConicRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(listener, emptyPoints));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(emptyPoints, qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(points, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(listener, emptyScores));

        // test constructor with listener, points and quality scores
        estimator = new PROMedSConicRobustEstimator(listener, points, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(listener, emptyPoints,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSConicRobustEstimator(listener, points,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROMedSConicRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSConicRobustEstimator(this, pointsWithError, qualityScores);
    ...
    private static void checkLocked(final PROMedSConicRobustEstimator estimator) {
