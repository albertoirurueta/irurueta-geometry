 ...
 * com.irurueta.geometry.estimator.PROMedSConicRobustEstimator
 * 
...
public class PROMedSConicRobustEstimatorTest implements 
    ...
    public PROMedSConicRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        PROMedSConicRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new PROMedSConicRobustEstimator();
    ...
    public void onEstimateStart(ConicRobustEstimator estimator) {
        estimateStart++;
        testLocked((PROMedSConicRobustEstimator)estimator);
    }
    ...
    private void testLocked(PROMedSConicRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
