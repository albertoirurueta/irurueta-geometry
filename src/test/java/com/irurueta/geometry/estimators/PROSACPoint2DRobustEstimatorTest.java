...
public class PROSACPoint2DRobustEstimatorTest implements
    ...
    public PROSACPoint2DRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        PROSACPoint2DRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new PROSACPoint2DRobustEstimator();
    ...
    public void onEstimateStart(Point2DRobustEstimator estimator) {
        estimateStart++;
        testLocked((PROSACPoint2DRobustEstimator)estimator);
    }
    ...
    private void testLocked(PROSACPoint2DRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
