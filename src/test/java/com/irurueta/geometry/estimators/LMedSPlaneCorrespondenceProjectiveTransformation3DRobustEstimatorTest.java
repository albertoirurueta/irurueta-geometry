...
class LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator();

        assertEquals(LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(inputPlanes, outputPlanes);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(planesEmpty, planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(inputPlanes, planesEmpty));

        // test constructor with listener
        estimator = new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this);
        ...
        estimator = new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this, inputPlanes,
                outputPlanes);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this, planesEmpty,
                        planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this, inputPlanes,
                        planesEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator(this,
    ...
    private static void checkLocked(final LMedSPlaneCorrespondenceProjectiveTransformation3DRobustEstimator estimator) {
