...
public class RANSACPlaneRobustEstimatorTest implements 
    ...
    public RANSACPlaneRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        RANSACPlaneRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new RANSACPlaneRobustEstimator();
    ...
    public void onEstimateStart(PlaneRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACPlaneRobustEstimator)estimator);
    }
    ...
    private void testLocked(RANSACPlaneRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
