...
class RANSACPlaneRobustEstimatorTest implements PlaneRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACPlaneRobustEstimator();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACPlaneRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACPlaneRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACPlaneRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACPlaneRobustEstimator(this, pointsWithError);
    ...
    private static void checkLocked(final RANSACPlaneRobustEstimator estimator) {
