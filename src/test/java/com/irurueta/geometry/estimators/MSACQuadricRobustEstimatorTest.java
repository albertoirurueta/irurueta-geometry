 ...
 * com.irurueta.geometry.estimators.MSACQuadricRobustEstimator
 * 
...
public class MSACQuadricRobustEstimatorTest implements 
    ...
    public void onEstimateStart(QuadricRobustEstimator estimator) {
        estimateStart++;
        testLocked((MSACQuadricRobustEstimator)estimator);
    }
    ...
    private void testLocked(MSACQuadricRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
