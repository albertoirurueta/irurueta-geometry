...
public class MSACDualConicRobustEstimatorTest implements
    ...
    public void testConstants() {
        assertEquals(1e-7, MSACDualConicRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, MSACDualConicRobustEstimator.MIN_THRESHOLD,
                0.0);
    }
    ...
    public void testConstructor() {
        ...
        MSACDualConicRobustEstimator estimator = new MSACDualConicRobustEstimator();

        // check correctness
        assertEquals(MSACDualConicRobustEstimator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetThreshold() throws LockedException {
        final MSACDualConicRobustEstimator estimator =
    ...
    private void checkLocked(final MSACDualConicRobustEstimator estimator) {
        try {
            estimator.setThreshold(0.5);
