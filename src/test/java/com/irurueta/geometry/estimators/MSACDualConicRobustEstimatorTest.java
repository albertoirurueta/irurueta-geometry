...
class MSACDualConicRobustEstimatorTest implements DualConicRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1e-7, MSACDualConicRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, MSACDualConicRobustEstimator.MIN_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new MSACDualConicRobustEstimator();

        // check correctness
        assertEquals(MSACDualConicRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACDualConicRobustEstimator(emptyLines));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACDualConicRobustEstimator(listener, emptyLines));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACDualConicRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACDualConicRobustEstimator(this, linesWithError);
    ...
    private static void checkLocked(final MSACDualConicRobustEstimator estimator) {
