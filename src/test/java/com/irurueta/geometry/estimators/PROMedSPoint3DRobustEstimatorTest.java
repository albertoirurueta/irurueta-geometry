...
class PROMedSPoint3DRobustEstimatorTest implements Point3DRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSPoint3DRobustEstimator();

        // check correctness
        assertEquals(PROMedSPoint3DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(emptyPlanes));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(listener, emptyPlanes));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(emptyScores));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(emptyPlanes,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(planes, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(listener, emptyScores));

        // test constructor with listener, planes and quality scores
        estimator = new PROMedSPoint3DRobustEstimator(listener, planes, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(listener, emptyPlanes,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint3DRobustEstimator(listener, planes,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROMedSPoint3DRobustEstimator();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        var qualityScores = new double[Point3DRobustEstimator.MINIMUM_SIZE];
        estimator.setQualityScores(qualityScores);
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSPoint3DRobustEstimator(this, planesWithError, qualityScores);
    ...
    private static void checkLocked(final PROMedSPoint3DRobustEstimator estimator) {
