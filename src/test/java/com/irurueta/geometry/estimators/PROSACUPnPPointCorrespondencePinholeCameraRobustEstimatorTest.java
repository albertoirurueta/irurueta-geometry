...
class PROSACUPnPPointCorrespondencePinholeCameraRobustEstimatorTest implements PinholeCameraRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator();
        ...
        estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(points3DEmpty, points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2DEmpty));

        // test constructor with listener and points
        estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D, points2D);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3DEmpty,
                        points2DEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
                        points2DEmpty));

        // test constructor without arguments
        final var qualityScores = new double[points2D.size()];
        estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(qualityScores);
        ...
        // test constructor with listener
        estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, qualityScores);
        ...
        // test constructor with points
        estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(points3D, points2D, qualityScores);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        final var qualityScores = new double[
                PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator.MIN_NUMBER_OF_POINT_CORRESPONDENCES];
    ...
    void testEstimateGeneralNoSuggestion() throws LockedException, NotReadyException, CameraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator(this, points3D,
    ...
    public void onEstimateStart(final PinholeCameraRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROSACUPnPPointCorrespondencePinholeCameraRobustEstimator estimator) {
        final var points3D = new ArrayList<Point3D>();
        final var points2D = new ArrayList<Point2D>();
