...
class MSACPlaneCorrespondenceAffineTransformation3DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator();
        ...
        estimator = new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, outputPlanes);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(planesEmpty, planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, planesEmpty));

        // test constructor with listener
        estimator = new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this);
        ...
        estimator = new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, inputPlanes,
                outputPlanes);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, planesEmpty,
                        planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, inputPlanes,
                        planesEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var i = 0; i < nPlanes; i++) {
            ...
            if (randomizer.nextInt(0, 100) < PERCENTAGE_OUTLIER) {
                ...
                outputPlaneWithError = new Plane(outputPlane.getA() + errorA, outputPlane.getB() + errorB,
                        outputPlane.getC() + errorC, outputPlane.getD() + errorD);
            } else {
        ...
        final var estimator = new MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator(this,
    ...
    private static void checkLocked(final MSACPlaneCorrespondenceAffineTransformation3DRobustEstimator estimator) {
