...
class PROSACCircleRobustEstimatorTest implements CircleRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, PROSACCircleRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, PROSACCircleRobustEstimator.MIN_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new PROSACCircleRobustEstimator();

        // check correctness
        assertEquals(PROSACCircleRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(listener, emptyPoints));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(emptyPoints, qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(points, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(listener, emptyScores));

        // test constructor with listener, points and quality scores
        estimator = new PROSACCircleRobustEstimator(listener, points, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(listener, emptyPoints,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROSACCircleRobustEstimator(listener, points,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACCircleRobustEstimator();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        var qualityScores = new double[CircleRobustEstimator.MINIMUM_SIZE];
        estimator.setQualityScores(qualityScores);
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACCircleRobustEstimator(this, pointsWithError, qualityScores);
    ...
    public void onEstimateStart(final CircleRobustEstimator estimator) {
        estimateStart++;
        checkLocked((PROSACCircleRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final PROSACCircleRobustEstimator estimator) {
