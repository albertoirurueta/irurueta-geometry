...
public class PROSACCircleRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        PROSACCircleRobustEstimator estimator = new PROSACCircleRobustEstimator();

        // check correctness
        assertEquals(PROSACCircleRobustEstimator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetThreshold() throws LockedException {
        final PROSACCircleRobustEstimator estimator =
    ...
    private void checkLocked(final PROSACCircleRobustEstimator estimator) {
        try {
            estimator.setThreshold(0.5);
