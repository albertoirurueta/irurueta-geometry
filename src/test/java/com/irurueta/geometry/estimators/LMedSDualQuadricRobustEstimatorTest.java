...
class LMedSDualQuadricRobustEstimatorTest implements DualQuadricRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1e-9, LMedSDualQuadricRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSDualQuadricRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new LMedSDualQuadricRobustEstimator();

        // check correctness
        assertEquals(LMedSDualQuadricRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        estimator = new LMedSDualQuadricRobustEstimator(planes);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSDualQuadricRobustEstimator(emptyPlanes));
        ...
        estimator = new LMedSDualQuadricRobustEstimator(listener);
        ...
        estimator = new LMedSDualQuadricRobustEstimator(listener, planes);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSDualQuadricRobustEstimator(listener, emptyPlanes));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSDualQuadricRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var theta = Math.toRadians((double) nPlanes / 360.0);
            ...
            for (var i = 0; i < nPlanes; i++) {
                ...
                final var point = new HomogeneousPoint3D(
                        ...
                        center.getInhomZ() + radius * Math.sin(angle2), 1.0);
            ...
            final var estimator = new LMedSDualQuadricRobustEstimator(this, planesWithError);
    ...
    public void onEstimateStart(final DualQuadricRobustEstimator estimator) {
        estimateStart++;
        checkLocked((LMedSDualQuadricRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final LMedSDualQuadricRobustEstimator estimator) {
