...
public class LMedSDualQuadricRobustEstimatorTest implements
    ...
    public void testConstants() {
        assertEquals(1e-9, LMedSDualQuadricRobustEstimator.DEFAULT_STOP_THRESHOLD,
                0.0);
        assertEquals(0.0, LMedSDualQuadricRobustEstimator.MIN_STOP_THRESHOLD,
                0.0);
    }

    @Test
    public void testConstructor() {
        LMedSDualQuadricRobustEstimator estimator;

        // test constructor without arguments
        estimator = new LMedSDualQuadricRobustEstimator();

        // check correctness
        assertEquals(LMedSDualQuadricRobustEstimator.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new LMedSDualQuadricRobustEstimator(emptyPlanes);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSDualQuadricRobustEstimator estimator =
                new LMedSDualQuadricRobustEstimator();
    ...
    public void testEstimate() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSDualQuadricRobustEstimator estimator =
                    new LMedSDualQuadricRobustEstimator(this, planesWithError);
    ...
    private void checkLocked(final LMedSDualQuadricRobustEstimator estimator) {
        try {
            estimator.setStopThreshold(0.5);
