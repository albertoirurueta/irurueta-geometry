 ...
 * com.irurueta.geometry.estimators.LMedSDualQuadricRobustEstimator
 * 
...
public class LMedSDualQuadricRobustEstimatorTest implements
    ...
    public LMedSDualQuadricRobustEstimatorTest() {}
    ...
    public void onEstimateStart(DualQuadricRobustEstimator estimator) {
        estimateStart++;
        testLocked((LMedSDualQuadricRobustEstimator)estimator);
    }
    ...
    private void testLocked(LMedSDualQuadricRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
