...
class PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimatorTest
    ...
    void testConstants() {
        ...
        assertEquals(1e-6, PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(0.0, PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator.MIN_THRESHOLD,
                0.0);
        assertFalse(PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(
                PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator();
        ...
        estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(inputLines, outputLines);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(linesEmpty, linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(inputLines, linesEmpty));

        // test constructor with listener
        estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this);
        ...
        estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this, inputLines,
                outputLines);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this, linesEmpty,
                        linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this, inputLines,
                        linesEmpty));
        ...
        estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(shortQualityScores));
        ...
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(inputLines, outputLines,
                        shortQualityScores));

        // test constructor with listener and quality scores
        estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this, qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this,
                        shortQualityScores));
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        final var estimator = new PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator(this,
        ...
        for (var i = 0; i < nLines; i++) {
            ...
            l1.normalize();
            l2.normalize();
            assertEquals(0.0, LineCorrespondenceProjectiveTransformation2DRobustEstimator.getResidual(l1, l2),
                    ABSOLUTE_ERROR);
    ...
    private static void checkLocked(final PROSACLineCorrespondenceProjectiveTransformation2DRobustEstimator estimator) {
