...
class PROSACDualConicRobustEstimatorTest implements DualConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACDualConicRobustEstimator();

        // check correctness
        assertEquals(PROSACDualConicRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(emptyLines));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(listener, emptyLines));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(emptyScores));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(emptyLines,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(lines, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(listener, emptyScores));

        // test constructor with listener, points and quality scores
        estimator = new PROSACDualConicRobustEstimator(listener, lines, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(listener, emptyLines,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROSACDualConicRobustEstimator(listener, lines,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACDualConicRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACDualConicRobustEstimator(this, linesWithError, qualityScores);
    ...
    private static void checkLocked(final PROSACDualConicRobustEstimator estimator) {
