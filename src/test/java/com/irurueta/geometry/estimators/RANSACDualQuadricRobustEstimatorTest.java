...
class RANSACDualQuadricRobustEstimatorTest implements DualQuadricRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACDualQuadricRobustEstimator();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACDualQuadricRobustEstimator(emptyPlanes));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACDualQuadricRobustEstimator(listener, emptyPlanes));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACDualQuadricRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACDualQuadricRobustEstimator(this, planesWithError);
    ...
    private static void checkLocked(final RANSACDualQuadricRobustEstimator estimator) {
