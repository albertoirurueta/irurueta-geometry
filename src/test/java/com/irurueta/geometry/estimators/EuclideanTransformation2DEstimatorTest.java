...
public class EuclideanTransformation2DEstimatorTest implements 
    ...
    public EuclideanTransformation2DEstimatorTest() { }
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < EuclideanTransformation2DEstimator.MINIMUM_SIZE; 
                ...
                double x = randomizer.nextDouble(MIN_TRANSLATION, 
                        MAX_TRANSLATION);
                double y = randomizer.nextDouble(MIN_TRANSLATION, 
                        MAX_TRANSLATION);
    ...
    @Override
    public void onEstimateEnd(EuclideanTransformation2DEstimator estimator) {
        estimateEnd++;
        checkLocked(estimator);
    }
