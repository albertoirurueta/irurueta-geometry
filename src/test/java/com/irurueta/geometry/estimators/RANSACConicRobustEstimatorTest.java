...
class RANSACConicRobustEstimatorTest implements ConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACConicRobustEstimator();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACConicRobustEstimator(emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACConicRobustEstimator(listener, emptyPoints));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACConicRobustEstimator();
    ...
    void testEstimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACConicRobustEstimator(this, pointsWithError);
    ...
    private static void checkLocked(final RANSACConicRobustEstimator estimator) {
