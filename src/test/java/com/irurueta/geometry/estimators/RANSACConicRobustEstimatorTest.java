...
public class RANSACConicRobustEstimatorTest implements 
    ...
    public RANSACConicRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        RANSACConicRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new RANSACConicRobustEstimator();
    ...
    public void onEstimateStart(ConicRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACConicRobustEstimator)estimator);
    }
    ...
    private void testLocked(RANSACConicRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
