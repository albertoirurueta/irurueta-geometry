...
class LMedSPoint3DRobustEstimatorTest implements Point3DRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1e-3, LMedSPoint3DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSPoint3DRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new LMedSPoint3DRobustEstimator();

        // check correctness
        assertEquals(LMedSPoint3DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSPoint3DRobustEstimator(emptyPlanes));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSPoint3DRobustEstimator(listener, emptyPlanes));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSPoint3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSPoint3DRobustEstimator(this, planesWithError);
    ...
    private static void checkLocked(final LMedSPoint3DRobustEstimator estimator) {
