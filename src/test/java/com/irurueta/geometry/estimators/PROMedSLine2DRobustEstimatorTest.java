...
public class PROMedSLine2DRobustEstimatorTest implements 
    ...
    public PROMedSLine2DRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        PROMedSLine2DRobustEstimator estimator;
        
        //test constructor without arguments
        estimator = new PROMedSLine2DRobustEstimator();
    ...
    public void onEstimateStart(Line2DRobustEstimator estimator) {
        estimateStart++;
        testLocked((PROMedSLine2DRobustEstimator)estimator);
    }
    ...
    private void testLocked(PROMedSLine2DRobustEstimator estimator){
        try{
            estimator.setStopThreshold(0.5);
