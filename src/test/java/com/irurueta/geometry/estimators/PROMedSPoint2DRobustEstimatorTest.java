...
class PROMedSPoint2DRobustEstimatorTest implements Point2DRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSPoint2DRobustEstimator();

        // check correctness
        assertEquals(PROMedSPoint2DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(emptyLines));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(listener, emptyLines));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(emptyScores));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(emptyLines,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(lines, emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(listener, emptyScores));

        // test constructor with listener, lines and quality scores
        estimator = new PROMedSPoint2DRobustEstimator(listener, lines, qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(listener, emptyLines,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSPoint2DRobustEstimator(listener, lines,
                emptyScores));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROMedSPoint2DRobustEstimator();
    ...
    void testGetSetLines() throws LockedException {
        final PROMedSPoint2DRobustEstimator estimator = new PROMedSPoint2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSPoint2DRobustEstimator(this, linesWithError, qualityScores);
    ...
    private static void checkLocked(final PROMedSPoint2DRobustEstimator estimator) {
