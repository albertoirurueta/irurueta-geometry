...
class RANSACPointCorrespondenceAffineTransformation3DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator();
        ...
        estimator = new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(inputPoints, pointsEmpty));

        // test constructor with listener
        estimator = new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(this);
        ...
        estimator = new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(this, inputPoints,
                        pointsEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        final var estimator = new RANSACPointCorrespondenceAffineTransformation3DRobustEstimator(this,
    ...
    public void onEstimateStart(final AffineTransformation3DRobustEstimator estimator) {
        estimateStart++;
        checkLocked((RANSACPointCorrespondenceAffineTransformation3DRobustEstimator) estimator);
    }
    ...
    private void checkLocked(final RANSACPointCorrespondenceAffineTransformation3DRobustEstimator estimator) {
