...
public class RANSACMetricTransformation2DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(RANSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(RANSACMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(RANSACMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS,
