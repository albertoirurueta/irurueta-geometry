 ...
 * com.irurueta.geometry.estimators.MSACPlaneRobustEstimator
 * 
...
public class MSACPlaneRobustEstimatorTest implements 
    ...
    public void onEstimateStart(PlaneRobustEstimator estimator) {
        estimateStart++;
        testLocked((MSACPlaneRobustEstimator)estimator);
    }
    ...
    private void testLocked(MSACPlaneRobustEstimator estimator){
        try{
            estimator.setThreshold(0.5);
