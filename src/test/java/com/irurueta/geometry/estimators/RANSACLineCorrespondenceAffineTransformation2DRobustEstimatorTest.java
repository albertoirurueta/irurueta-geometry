...
class RANSACLineCorrespondenceAffineTransformation2DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator();
        ...
        estimator = new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(inputLines, outputLines);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(linesEmpty, linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(inputLines, linesEmpty));

        // test constructor with listener
        estimator = new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(this);
        ...
        estimator = new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(this, inputLines,
                outputLines);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(this, linesEmpty,
                        linesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(this, inputLines,
                        linesEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACLineCorrespondenceAffineTransformation2DRobustEstimator(this,
    ...
    private static void checkLocked(final RANSACLineCorrespondenceAffineTransformation2DRobustEstimator estimator) {
