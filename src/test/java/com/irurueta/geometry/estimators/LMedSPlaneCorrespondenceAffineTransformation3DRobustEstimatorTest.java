...
class LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator();

        assertEquals(LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(), 0.0);
        assertEquals(LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        estimator = new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, outputPlanes);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(planesEmpty, planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(inputPlanes, planesEmpty));

        // test constructor with listener
        estimator = new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(this);
        ...
        estimator = new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, inputPlanes,
                outputPlanes);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, planesEmpty,
                        planesEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(this, inputPlanes,
                        planesEmpty));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        final var estimator = new LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(this,
    ...
    private static void testLocked(final LMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator estimator) {
