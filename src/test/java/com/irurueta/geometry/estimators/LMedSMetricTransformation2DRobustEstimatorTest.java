...
class LMedSMetricTransformation2DRobustEstimatorTest implements MetricTransformation2DRobustEstimatorListener {
    ...
    @Test
    void testConstants() {
        assertEquals(1.0, LMedSMetricTransformation2DRobustEstimator.DEFAULT_STOP_THRESHOLD, 0.0);
        assertEquals(0.0, LMedSMetricTransformation2DRobustEstimator.MIN_STOP_THRESHOLD, 0.0);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new LMedSMetricTransformation2DRobustEstimator();

        assertEquals(LMedSMetricTransformation2DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        assertEquals(LMedSMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        assertEquals(LMedSMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        ...
        estimator = new LMedSMetricTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation2DRobustEstimator(pointsEmpty,
                pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation2DRobustEstimator(inputPoints,
                pointsEmpty));
        ...
        estimator = new LMedSMetricTransformation2DRobustEstimator(this, inputPoints, outputPoints);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new LMedSMetricTransformation2DRobustEstimator(this,
        ...
        estimator = new LMedSMetricTransformation2DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        assertEquals(LMedSMetricTransformation2DRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        assertEquals(LMedSMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(), 0.0);
        assertEquals(LMedSMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        assertEquals(RobustEstimatorMethod.LMEDS, estimator.getMethod());
        assertSame(inputPoints, estimator.getInputPoints());
        assertSame(outputPoints, estimator.getOutputPoints());
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSMetricTransformation2DRobustEstimator();
    ...
    void testIsSetWeakMinimumPointsAllowed() throws LockedException {
        final var estimator = new LMedSEuclideanTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSMetricTransformation2DRobustEstimator(this, inputPoints,
    ...
    private static void checkLocked(final LMedSMetricTransformation2DRobustEstimator estimator) {
