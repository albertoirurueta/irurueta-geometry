...
public class PROSACMetricTransformation2DRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD,
                estimator.getThreshold(), 0.0);
        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS,
        ...
        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE,
                estimator.getConfidence(), 0.0);
        assertEquals(PROSACMetricTransformation2DRobustEstimator.
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final PROSACMetricTransformation2DRobustEstimator estimator =
                new PROSACMetricTransformation2DRobustEstimator();
