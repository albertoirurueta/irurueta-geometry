...
class PROSACMetricTransformation2DRobustEstimatorTest implements MetricTransformation2DRobustEstimatorListener {
    ...
    void testConstants() {
        ...
        assertEquals(1.0, PROSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(0.0, PROSACMetricTransformation2DRobustEstimator.MIN_THRESHOLD, 0.0);
        assertFalse(PROSACMetricTransformation2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertFalse(PROSACMetricTransformation2DRobustEstimator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    }

    @Test
    void testConstructor() {
        // test constructor without arguments
        var estimator = new PROSACMetricTransformation2DRobustEstimator();

        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
        assertEquals(PROSACMetricTransformation2DRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        ...
        estimator = new PROSACMetricTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(
        ...
        estimator = new PROSACMetricTransformation2DRobustEstimator(this, inputPoints, outputPoints);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(this,
                pointsEmpty, pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(this,
                inputPoints, pointsEmpty));
        ...
        estimator = new PROSACMetricTransformation2DRobustEstimator(qualityScores);
        ...
        estimator = new PROSACMetricTransformation2DRobustEstimator(inputPoints, outputPoints, qualityScores);
        ...
        // Force IllegalArgumentException
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(pointsEmpty,
                pointsEmpty, qualityScores));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(inputPoints,
                pointsEmpty, qualityScores));
        // not enough scores
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(inputPoints,
        ...
        estimator = new PROSACMetricTransformation2DRobustEstimator(this, qualityScores);
        ...
        estimator = new PROSACMetricTransformation2DRobustEstimator(inputPoints2, outputPoints2,
                true);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(pointsEmpty,
                pointsEmpty, true));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(inputPoints2,
                pointsEmpty, true));
        ...
        // test constructor with listener and points
        estimator = new PROSACMetricTransformation2DRobustEstimator(this, inputPoints2, outputPoints2,
                true);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(pointsEmpty,
                pointsEmpty, qualityScores, true));
        // different sizes
        assertThrows(IllegalArgumentException.class, () -> new PROSACMetricTransformation2DRobustEstimator(inputPoints,
                pointsEmpty, qualityScores, true));
        // not enough scores
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROSACMetricTransformation2DRobustEstimator();
    ...
    void testEstimateWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var estimator = new PROSACMetricTransformation2DRobustEstimator(this, inputPoints,
    ...
    private static void checkLocked(final PROSACMetricTransformation2DRobustEstimator estimator) {
