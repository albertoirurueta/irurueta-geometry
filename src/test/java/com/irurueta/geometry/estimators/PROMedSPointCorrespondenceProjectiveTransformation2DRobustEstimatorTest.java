...
class PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimatorTest
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator();
        ...
        estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(inputPoints, outputPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(inputPoints,
                        pointsEmpty));

        // test constructor with listener
        estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this);
        ...
        estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this, inputPoints,
                outputPoints);
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this, pointsEmpty,
                        pointsEmpty));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this, inputPoints,
                        pointsEmpty));
        ...
        estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(qualityScores);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(shortQualityScores));
        ...
        // not enough points
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(pointsEmpty, pointsEmpty,
                        qualityScores));
        // different sizes
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(inputPoints, pointsEmpty,
                        qualityScores));
        // not enough scores
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(inputPoints, outputPoints,
                        shortQualityScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this,
                        shortQualityScores));
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        // set new value
        var qualityScores = new double[PointCorrespondenceProjectiveTransformation2DRobustEstimator.MINIMUM_SIZE];
    ...
    void testEstimateWithoutRefinement() throws WrongSizeException, DecomposerException, LockedException,
        ...
        final var estimator = new PROMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator(this,
