...
public class PROMedSFundamentalMatrixRobustEstimatorTest implements 
    ...
    public PROMedSFundamentalMatrixRobustEstimatorTest() { }
    ...
    public void onEstimateStart(FundamentalMatrixRobustEstimator estimator) {
        estimateStart++;
        //testLocked((PROMedSFundamentalMatrixRobustEstimator)estimator);
    }
    ...
    private void testLocked(PROMedSFundamentalMatrixRobustEstimator estimator) {
        try {
            estimator.setConfidence(0.5);
