...
class MetricTransformation2DTest {
    ...
    void testConstructor() throws CoincidentPointsException {
        ...
        var transformation = new MetricTransformation2D();

        // check correctness
        assertEquals(0.0, transformation.getRotation().getTheta(), 0.0);
        assertEquals(MetricTransformation2D.NUM_TRANSLATION_COORDS, transformation.getTranslation().length);
        ...
        assertThrows(NullPointerException.class, () -> new MetricTransformation2D((Rotation2D) null));

        // Test constructor with translation
        var translation = new double[MetricTransformation2D.NUM_TRANSLATION_COORDS];
        ...
        // Force NullPointerException
        assertThrows(NullPointerException.class, () -> new MetricTransformation2D((double[]) null));

        // Force IllegalArgumentException
        final var badTranslation = new double[MetricTransformation2D.NUM_TRANSLATION_COORDS + 1];
        assertThrows(IllegalArgumentException.class, () -> new MetricTransformation2D(badTranslation));
        ...
        assertThrows(NullPointerException.class,
                () -> new MetricTransformation2D(null, finalTranslation, finalScale));
        final var finalRotation = rotation;
        assertThrows(NullPointerException.class,
                () -> new MetricTransformation2D(finalRotation, null, finalScale));

        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new MetricTransformation2D(finalRotation, badTranslation, finalScale));
        ...
        translation = new double[MetricTransformation2D.NUM_TRANSLATION_COORDS];
        ...
        final var transformation2 = new MetricTransformation2D(inputPoint1, inputPoint2, inputPoint3, outputPoint1,
    ...
    void testGetSetTranslation() {
        ...
        final var randomizer = new UniformRandomizer();
        final var translation = new double[MetricTransformation2D.NUM_TRANSLATION_COORDS];
        randomizer.fill(translation, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
    ...
    void testAddTranslation() {
        ...
        final var randomizer = new UniformRandomizer();
        final var translation1 = new double[MetricTransformation2D.NUM_TRANSLATION_COORDS];
        randomizer.fill(translation1, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        final var translation2 = new double[MetricTransformation2D.NUM_TRANSLATION_COORDS];
        ...
        // set new value
        final var translationCopy = Arrays.copyOf(translation1, MetricTransformation2D.NUM_TRANSLATION_COORDS);
    ...
    void testAsMatrix() throws WrongSizeException {
        ...
        final var transMatrix2 = new Matrix(MetricTransformation2D.HOM_COORDS, MetricTransformation2D.HOM_COORDS);
        ...
        final var t = new Matrix(MetricTransformation2D.HOM_COORDS + 1,
    ...
    void testTransformConicAndPoints() throws AlgebraException, GeometryException {
        ...
        do {
            ...
            try {
                ...
                // if points are not valid, repeat
            }
        } while (conic == null);
    ...
    void testInverse() throws WrongSizeException {
        ...
        final var invTransformation2 = new MetricTransformation2D();
    ...
    void testCombine() throws WrongSizeException {
        ...
        var transformation1 = new MetricTransformation2D(rotation1, translation1, scale1);
        final var transformation2 = new MetricTransformation2D(rotation2, translation2, scale2);
        ...
        assertEquals(expectedRotation.getTheta(), transformation1.getRotation().getTheta(), ABSOLUTE_ERROR);
        assertEquals(expectedRotation.getTheta(), transformation3.getRotation().getTheta(), ABSOLUTE_ERROR);
        ...
        var euclideanTransformation = new EuclideanTransformation2D(rotation2, translation2);
    ...
    void testSetTransformationFromPoints() throws CoincidentPointsException {
        ...
        final var transformation2 = new MetricTransformation2D();
    ...
    void testSerializeDeserialize() throws IOException, ClassNotFoundException {
        ...
        final var transformation2 = SerializationHelper.<MetricTransformation2D>deserialize(bytes);
    ...
    private static void transformPoint(
            final Point2D inputPoint, final Point2D outputPoint, final Rotation2D rotation, final double[] translation,
            final double scale) {
    ...
    private static void transformLine(
            final Line2D inputLine, final Line2D outputLine, final MetricTransformation2D transformation)
    ...
    private static void transformConic(
            final Conic inputConic, final Conic outputConic, final MetricTransformation2D transformation)
    ...
    private static void transformDualConic(
            ...
            final MetricTransformation2D transformation) throws WrongSizeException, NonSymmetricMatrixException {
