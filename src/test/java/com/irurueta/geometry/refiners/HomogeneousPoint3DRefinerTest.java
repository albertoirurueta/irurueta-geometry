...
class HomogeneousPoint3DRefinerTest implements RefinerListener<HomogeneousPoint3D> {
    ...
    void testConstructor() throws LockedException, NotReadyException, ColinearPointsException,
        ...
        final var point = new HomogeneousPoint3D(estimator.estimate());
        ...
        var refiner = new HomogeneousPoint3DRefiner();
        ...
        refiner = new HomogeneousPoint3DRefiner(point, true, inliers, residuals, numInliers, samples,
        ...
        refiner = new HomogeneousPoint3DRefiner(point, true, inliersData, samples,
                refinementStandardDeviation);
    ...
    void testGetSetListener() {
        final var refiner = new HomogeneousPoint3DRefiner();
    ...
    void testRefine() throws ColinearPointsException, LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < 5 * TIMES; t++) {
            ...
            final var refiner = new HomogeneousPoint3DRefiner(point, true, inliersData, samples,
                    refineStandardDeviation);
            refiner.setListener(this);

            final var result1 = new HomogeneousPoint3D();
    ...
    @Override
    public void onRefineStart(final Refiner<HomogeneousPoint3D> refiner, final HomogeneousPoint3D initialEstimation) {
        refineStart++;
    ...
    private static void checkLocked(final HomogeneousPoint3DRefiner refiner) {
