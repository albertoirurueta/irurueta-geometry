 ...
 * com.irurueta.geometry.slam.ConstantVelocityModelSlamEstimator
 * 
...
public class ConstantVelocityModelSlamEstimatorTest implements 
    ...
    public ConstantVelocityModelSlamEstimatorTest() {}
    ...
    public void testConstructor() throws WrongSizeException {
        ConstantVelocityModelSlamEstimator estimator = 
    ...
    public void testCreateCalibrator() {
        assertTrue(ConstantVelocityModelSlamEstimator.createCalibrator() 
                instanceof ConstantVelocityModelSlamCalibrator);
    }
    ...
    public void testPredictionWithNoiseAndInitialState() {
        ...
        assertTrue(numSuccess > 5*REPEAT_TIMES * REQUIRED_PREDICTION_SUCCESS_RATE);        
    }
    ...
    public void testPredictionNoMotionWithNoiseAndCalibration() {
        ...
        for (int t = 0; t < 5*REPEAT_TIMES; t++) {
            ...
            ConstantVelocityModelSlamCalibrator calibrator = 
                    ...
                    noiseRandomizer);
            ConstantVelocityModelSlamCalibrationData calibration = 
            ...
            ConstantVelocityModelSlamEstimator estimatorWithCalibration = 
                    new ConstantVelocityModelSlamEstimator();
