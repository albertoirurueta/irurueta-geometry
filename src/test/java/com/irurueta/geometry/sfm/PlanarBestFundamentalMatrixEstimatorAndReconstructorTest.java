 ...
 * com.irurueta.geometry.sfm.PlanarBestFundamentalMatrixEstimatorAndReconstructor
 * 
...
import com.irurueta.geometry.epipolar.estimators.FundamentalMatrixEstimatorException;
...
public class PlanarBestFundamentalMatrixEstimatorAndReconstructorTest implements 
    ...
    public void testEstimateAndReconstruct() 
            ...
            FundamentalMatrixEstimatorException, NotAvailableException {
        int numValid = 0;
        for (int t = 0; t < TIMES; t++) {
            ...
            assertTrue(areEqualUpToScale(fundamentalMatrix, 
                    er.getFundamentalMatrix(), ABSOLUTE_ERROR));
