...
public class PROMedSRobustSinglePoint3DTriangulatorTest implements 
    ...
    public static final double ABSOLUTE_ERROR = 5e-4;
    ...
    public PROMedSRobustSinglePoint3DTriangulatorTest() {}
    ...
    public void testConstructor(){
        PROMedSRobustSinglePoint3DTriangulator triangulator;
    ...
    public void onTriangulateStart(
        ...
        triangulateStart++;
        testLocked((PROMedSRobustSinglePoint3DTriangulator)triangulator);
    }
    ...
    private void testLocked(PROMedSRobustSinglePoint3DTriangulator triangulator){
        try{
            triangulator.setStopThreshold(0.5);
