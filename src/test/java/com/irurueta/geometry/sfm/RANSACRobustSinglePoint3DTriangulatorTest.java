 ...
 * com.irurueta.geometry.sfm.RANSACRobustSinglePoint3DTriangulator
 * 
...
public class RANSACRobustSinglePoint3DTriangulatorTest implements 
    ...
    public RANSACRobustSinglePoint3DTriangulatorTest() {}
    ...
    public void testConstructor(){
        RANSACRobustSinglePoint3DTriangulator triangulator;
    ...
    public void onTriangulateStart(
        ...
        triangulateStart++;
        testLocked((RANSACRobustSinglePoint3DTriangulator)triangulator);
    }
    ...
    private void testLocked(RANSACRobustSinglePoint3DTriangulator triangulator){
        try{
            triangulator.setThreshold(0.5);
