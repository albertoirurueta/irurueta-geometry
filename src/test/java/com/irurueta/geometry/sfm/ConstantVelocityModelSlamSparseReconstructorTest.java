...
public class ConstantVelocityModelSlamSparseReconstructorTest {
    ...
    public void testConstructor() {
        assertEquals(ConstantVelocityModelSlamSparseReconstructor.MIN_NUMBER_OF_VIEWS, 2);

        ConstantVelocityModelSlamSparseReconstructorConfiguration configuration =
        ...
        ConstantVelocityModelSlamSparseReconstructor reconstructor =
                new ConstantVelocityModelSlamSparseReconstructor(listener);
    ...
    public void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseTwoViews()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            ConstantVelocityModelSlamSparseReconstructor reconstructor =
                    new ConstantVelocityModelSlamSparseReconstructor(configuration, listener);
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            ConstantVelocityModelSlamSparseReconstructorListener listener =
                    new ConstantVelocityModelSlamSparseReconstructorListener() {
                        ...
                        @Override
                        public void onStart(ConstantVelocityModelSlamSparseReconstructor reconstructor) {
                            mStarted = true;
                        }

                        @Override
                        public void onFinish(ConstantVelocityModelSlamSparseReconstructor reconstructor) {
                            mFinished = true;
                        }

                        @Override
                        public void onCancel(ConstantVelocityModelSlamSparseReconstructor reconstructor) {
                            mCancelled = true;
                        }

                        @Override
                        public void onFail(ConstantVelocityModelSlamSparseReconstructor reconstructor) {
                            mFailed = true;
                        }
                    };
