...
public class EuclideanTransformation3DTest {
    ...
    @Test
    public void testConstructor() throws RotationException,
        ...
        final double[] badTranslation = new double[
                EuclideanTransformation3D.NUM_TRANSLATION_COORDS + 1];
        try {
    ...
    public void testAsMatrix() throws WrongSizeException {
        ...
        final Matrix transMatrix2 = new Matrix(EuclideanTransformation3D.HOM_COORDS,
                EuclideanTransformation3D.HOM_COORDS);
        ...
        final Matrix t = new Matrix(EuclideanTransformation3D.HOM_COORDS + 1,
    ...
    public void testInverse() throws WrongSizeException {
        ...
        final EuclideanTransformation3D invTransformation2 =
                new EuclideanTransformation3D();
    ...
    public void testCombine() throws WrongSizeException, RotationException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final EuclideanTransformation3D transformation1 =
                    new EuclideanTransformation3D(rotation1, translation1);
            final EuclideanTransformation3D transformation2 =
            ...
            final Rotation3D expectedRotation = rotation1.combineAndReturnNew(rotation2);
            ...
            if (Math.abs(transformation3.getRotation().getRotationAngle() -
                    expectedRotation.getRotationAngle()) > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAngle(),
                    expectedRotation.getRotationAngle(), ABSOLUTE_ERROR);
            if (Math.abs(transformation3.getRotation().getRotationAxis()[0] -
                    expectedRotation.getRotationAxis()[0]) > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAxis()[0],
                    expectedRotation.getRotationAxis()[0], ABSOLUTE_ERROR);
            if (Math.abs(transformation3.getRotation().getRotationAxis()[1] -
                    expectedRotation.getRotationAxis()[1]) > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAxis()[1],
                    expectedRotation.getRotationAxis()[1], ABSOLUTE_ERROR);
            if (Math.abs(transformation3.getRotation().getRotationAxis()[2] -
                    expectedRotation.getRotationAxis()[2]) > ABSOLUTE_ERROR) {
                continue;
            }
    ...
    private static void transformPlane(
            ...
            final EuclideanTransformation3D transformation) throws WrongSizeException,
