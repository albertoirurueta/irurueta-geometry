...
class EuclideanTransformation3DTest {
    ...
    void testConstructor() throws RotationException, CoincidentPointsException {
        ...
        var transformation = new EuclideanTransformation3D();
        ...
        assertEquals(EuclideanTransformation3D.NUM_TRANSLATION_COORDS, transformation.getTranslation().length);
        ...
        assertEquals(transformation.getRotation().getRotationAngle(), theta * sign, ABSOLUTE_ERROR);
        assertEquals(transformation.getRotation().getRotationAxis()[0], rotAxis[0] * sign, ABSOLUTE_ERROR);
        assertEquals(transformation.getRotation().getRotationAxis()[1], rotAxis[1] * sign, ABSOLUTE_ERROR);
        assertEquals(transformation.getRotation().getRotationAxis()[2], rotAxis[2] * sign, ABSOLUTE_ERROR);
        assertEquals(EuclideanTransformation3D.NUM_TRANSLATION_COORDS, transformation.getTranslation().length);
        assertEquals(0.0, transformation.getTranslation()[0], ABSOLUTE_ERROR);
        assertEquals(0.0, transformation.getTranslation()[1], ABSOLUTE_ERROR);
        assertEquals(0.0, transformation.getTranslation()[2], ABSOLUTE_ERROR);
        ...
        assertThrows(NullPointerException.class, () -> new EuclideanTransformation3D((Rotation3D) null));
        ...
        assertThrows(NullPointerException.class, () -> new EuclideanTransformation3D((double[]) null));

        // Force IllegalArgumentException
        final var badTranslation = new double[EuclideanTransformation3D.NUM_TRANSLATION_COORDS + 1];
        assertThrows(IllegalArgumentException.class, () -> new EuclideanTransformation3D(badTranslation));
        ...
        // Force NullPointerException
        assertThrows(NullPointerException.class, () -> new EuclideanTransformation3D(null, translation));
        assertThrows(NullPointerException.class, () -> new EuclideanTransformation3D(rotation, null));

        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new EuclideanTransformation3D(rotation, badTranslation));
        ...
        final var transformation2 = new EuclideanTransformation3D(inputPoint1, inputPoint2, inputPoint3, inputPoint4,
    ...
    void testAddRotation() throws RotationException {
        ...
        assertEquals(transformation.getRotation().getRotationAngle(), theta1 * sign, ABSOLUTE_ERROR);
        assertEquals(transformation.getRotation().getRotationAxis()[0], rotAxis1[0] * sign, ABSOLUTE_ERROR);
        assertEquals(transformation.getRotation().getRotationAxis()[1], rotAxis1[1] * sign, ABSOLUTE_ERROR);
        assertEquals(transformation.getRotation().getRotationAxis()[2], rotAxis1[2] * sign, ABSOLUTE_ERROR);
    ...
    void testAddTranslation() {
        ...
        // set new value
        final var translationCopy = Arrays.copyOf(translation1, EuclideanTransformation3D.NUM_TRANSLATION_COORDS);
    ...
    void testAsMatrix() throws WrongSizeException {
        ...
        final var transformation = new EuclideanTransformation3D(rotation, translation);
        ...
        final var transMatrix2 = new Matrix(EuclideanTransformation3D.HOM_COORDS, EuclideanTransformation3D.HOM_COORDS);
        ...
        final var t = new Matrix(EuclideanTransformation3D.HOM_COORDS + 1,
    ...
    void testTransformQuadricAndPoints() throws AlgebraException, GeometryException {
        ...
        do {
            ...
            try {
                ...
                // if quadric cannot be created, try again
            }
    ...
    void testTransformDualQuadricAndPlanes() throws AlgebraException, GeometryException {
        ...
        do {
            ...
            try {
                ...
                // if dual quadric cannot be created, try again
            }
    ...
    void testTransformPlaneAndPoints() throws AlgebraException, GeometryException {
        ...
        final var point1 = new HomogeneousPoint3D(m.getElementAt(0, 0), m.getElementAt(0, 1),
                m.getElementAt(0, 2), m.getElementAt(0, 3));
        final var point2 = new HomogeneousPoint3D(m.getElementAt(1, 0), m.getElementAt(1, 1),
                m.getElementAt(1, 2), m.getElementAt(1, 3));
        final var point3 = new HomogeneousPoint3D(m.getElementAt(2, 0), m.getElementAt(2, 1),
                m.getElementAt(2, 2), m.getElementAt(2, 3));
    ...
    void testTransformCamera() throws AlgebraException {
        ...
        final var cameraMatrix = Matrix.createWithUniformRandomValues(
    ...
    void testTransformCameraAndPoints() throws AlgebraException, GeometryException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var transformation = new EuclideanTransformation3D(rotation2, translation);
    ...
    void testInverse() throws WrongSizeException {
        ...
        final var invTransformation2 = new EuclideanTransformation3D();
        ...
        assertTrue(invTransformation1.asMatrix().multiplyAndReturnNew(
                transformation.asMatrix()).equals(Matrix.identity(EuclideanTransformation3D.HOM_COORDS,
                EuclideanTransformation3D.HOM_COORDS), ABSOLUTE_ERROR));
    ...
    void testCombine() throws WrongSizeException, RotationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var transformation1 = new EuclideanTransformation3D(rotation1, translation1);
            final var transformation2 = new EuclideanTransformation3D(rotation2, translation2);
            ...
            // check correctness
            if (!m1.equals(m3, ABSOLUTE_ERROR)) {
                continue;
            }
            ...
            // expected matrix
            if (!m1.equals(expectedMatrix, ABSOLUTE_ERROR)) {
                continue;
            }
            assertTrue(m1.equals(expectedMatrix, ABSOLUTE_ERROR));
            if (!m3.equals(expectedMatrix, ABSOLUTE_ERROR)) {
                continue;
            }
            assertTrue(m3.equals(expectedMatrix, ABSOLUTE_ERROR));

            // check also correctness of rotation and translation
            if (Math.abs(transformation1.getRotation().getRotationAngle() - expectedRotation.getRotationAngle())
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation1.getRotation().getRotationAngle(), expectedRotation.getRotationAngle(),
                    ABSOLUTE_ERROR);
            if (Math.abs(transformation1.getRotation().getRotationAxis()[0] - expectedRotation.getRotationAxis()[0])
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation1.getRotation().getRotationAxis()[0], expectedRotation.getRotationAxis()[0],
                    ABSOLUTE_ERROR);
            if (Math.abs(transformation1.getRotation().getRotationAxis()[1] - expectedRotation.getRotationAxis()[1])
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation1.getRotation().getRotationAxis()[1], expectedRotation.getRotationAxis()[1],
                    ABSOLUTE_ERROR);
            if (Math.abs(transformation1.getRotation().getRotationAxis()[2] - expectedRotation.getRotationAxis()[2])
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation1.getRotation().getRotationAxis()[2], expectedRotation.getRotationAxis()[2],
                    ABSOLUTE_ERROR);

            if (Math.abs(transformation3.getRotation().getRotationAngle() - expectedRotation.getRotationAngle())
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAngle(), expectedRotation.getRotationAngle(),
                    ABSOLUTE_ERROR);
            if (Math.abs(transformation3.getRotation().getRotationAxis()[0] - expectedRotation.getRotationAxis()[0])
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAxis()[0], expectedRotation.getRotationAxis()[0],
                    ABSOLUTE_ERROR);
            if (Math.abs(transformation3.getRotation().getRotationAxis()[1] - expectedRotation.getRotationAxis()[1])
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAxis()[1], expectedRotation.getRotationAxis()[1],
                    ABSOLUTE_ERROR);
            if (Math.abs(transformation3.getRotation().getRotationAxis()[2] - expectedRotation.getRotationAxis()[2])
                    > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(transformation3.getRotation().getRotationAxis()[2], expectedRotation.getRotationAxis()[2],
                    ABSOLUTE_ERROR);


            var failed = false;
            for (var i = 0; i < expectedTranslation.length; i++) {
                if (Math.abs(transformation1.getTranslation()[i] - expectedTranslation[i]) > ABSOLUTE_ERROR) {
                    failed = true;
                    break;
                }
            }
            ...
            for (var i = 0; i < expectedTranslation.length; i++) {
                if (Math.abs(transformation3.getTranslation()[i] - expectedTranslation[i]) > ABSOLUTE_ERROR) {
                    failed = true;
                    break;
                }
            }
    ...
    void testSetTransformationFromPoints() throws CoincidentPointsException {
        ...
        final var transformation2 = new EuclideanTransformation3D();
    ...
    void testSerializeDeserialize() throws IOException, ClassNotFoundException {
        ...
        final var transformation1 = new EuclideanTransformation3D(rotation, translation);
        ...
        final var transformation2 = SerializationHelper.<EuclideanTransformation3D>deserialize(bytes);
    ...
    private static void transformPoint(
            final Point3D inputPoint, final Point3D outputPoint, final Rotation3D rotation,
    ...
    private static void transformPlane(
            final Plane inputPlane, final Plane outputPlane, final EuclideanTransformation3D transformation)
    ...
    private static void transformQuadric(
            final Quadric inputQuadric, final Quadric outputQuadric, final EuclideanTransformation3D transformation)
    ...
    private static void transformDualQuadric(
            ...
            final EuclideanTransformation3D transformation) throws WrongSizeException, NonSymmetricMatrixException {
    ...
    private static void transformLine(
            final Line3D inputLine, final Line3D outputLine, final EuclideanTransformation3D transformation)
