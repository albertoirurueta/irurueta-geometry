...
public class RectangleTest {
    ...
    public void testConstructor(){
        ...
        double signedWidth = right - left;
        double signedHeight = bottom - top;
    ...
    public void testGetSetTopLeft(){
        ...
        //set new value
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        InhomogeneousPoint2D topLeft = new InhomogeneousPoint2D(
    ...
    public void testGetSetBottomRight(){
        ...
        //set new value
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        InhomogeneousPoint2D bottomRight = new InhomogeneousPoint2D(
                randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE),
                randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
    ...
    public void testSetCenterAndSize(){
        ...
        Point2D center = new InhomogeneousPoint2D(centerX, centerY);
        
        Point2D topLeft = new InhomogeneousPoint2D(centerX -0.5*width, 
                centerY - 0.5*height);
        Point2D bottomRight = new InhomogeneousPoint2D(centerX + 0.5*width, 
                centerY + 0.5*height);
    ...
    public void testIsInside(){
        ...
        double insideX = centerX + width*randomizer.nextDouble(-0.5, 0.5);
        double insideY = centerY + height*randomizer.nextDouble(-0.5, 0.5);
        
        double signX = randomizer.nextBoolean() ? 1 : -1;
        double signY = randomizer.nextBoolean() ? 1 : -1;
        double outsideX = centerX + 
                width*signX*randomizer.nextDouble(1.5, 2.5);
        double outsideY = centerY + 
                height*signY*randomizer.nextDouble(1.5, 2.5);
        
        Point2D insidePoint = new InhomogeneousPoint2D(insideX, insideY);
        Point2D outsidePoint = new InhomogeneousPoint2D(outsideX, outsideY);
        Point2D center = new InhomogeneousPoint2D(centerX, centerY);
        Point2D topLeft = new InhomogeneousPoint2D(left, top);
        Point2D bottomRight = new InhomogeneousPoint2D(right, bottom);
    ...
    public void testGetSignedDistanceToLeftSide(){
        ...
        Point2D topLeft = new InhomogeneousPoint2D(left, top);
        Point2D bottomLeft = new InhomogeneousPoint2D(left, bottom);
        Point2D bottomRight = new InhomogeneousPoint2D(right, bottom);        
        Point2D center = new InhomogeneousPoint2D(centerX, centerY);
    ...
    public void testGetSignedDistanceToTopSide(){
        ...
        Point2D topLeft = new InhomogeneousPoint2D(left, top);
        Point2D topRight = new InhomogeneousPoint2D(right, top);
        Point2D bottomRight = new InhomogeneousPoint2D(right, bottom);        
        Point2D center = new InhomogeneousPoint2D(centerX, centerY);
    ...
    public void testGetSignedDistance(){
        ...
        Rectangle r = new Rectangle(left, top, right, bottom);
        double leftDist = r.getDistanceToLeftSide(insidePoint);
        double topDist = r.getDistanceToTopSide(insidePoint);
        double rightDist = r.getDistanceToRightSide(insidePoint);
        double bottomDist = r.getDistanceToBottomSide(insidePoint);
        double insideDist = -Math.min(Math.min(leftDist, topDist), 
    ...
    public void testIsLocusToLeftSide(){
        ...
        Point2D pointAtLeftBorder = new InhomogeneousPoint2D(left, 
