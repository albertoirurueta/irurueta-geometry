...
public class Triangle3DTest {
    ...
    public void testConstructor() {
        ...
        Point3D point2 = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
        Point3D point3 = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));        
    ...
    public void testGetSetVertex1() {
        ...
        //new vertex1
        Point3D vertex1 = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
    ...
    public void testGetSetVertex2() {
        ...
        //new vertex1
        Point3D vertex2 = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
    ...
    public void testGetSetVertex3() {
        ...
        //new vertex1
        Point3D vertex3 = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
    ...
    public void testGetSetVertices() {
        ...
        Point3D point1b = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
        Point3D point2b = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
        Point3D point3b = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
    ...
    public void testAreaAndColinearPoints() throws WrongSizeException {
        ...
        //expected area
        double[] v1 = ArrayUtils.subtractAndReturnNew(point2.asArray(), 
                point1.asArray());
        double[] v2 = ArrayUtils.subtractAndReturnNew(point3.asArray(), 
                point1.asArray());
        
        double[] cross = Utils.crossProduct(v1, v2);
    ...
    public void testCenter() {
        ...
        Point3D expectedCenter = new InhomogeneousPoint3D((point1.getInhomX() +
    ...
    public void testClosestPoint() throws CoincidentPointsException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            //try for point1
            Point3D testPoint = Point3D.create();
            ...
            Point3D basePoint = new InhomogeneousPoint3D(base / 2.0, 0.0, 
                    zValue);
            ...
            Point3D pointLine1 = line1.getClosestPoint(center);
            Point3D pointLine2 = line2.getClosestPoint(center);
            Point3D pointLine3 = line3.getClosestPoint(center);
    ...
    public void testOrientationAndToPlane() throws ColinearPointsException, 
        ...
        double[] expectedOrientation = plane1.getDirectorVector();        
        ...
        double[] orientation1 = triangle.getOrientation();
        double[] orientation2 = triangle.getOrientation(ABSOLUTE_ERROR);
        double[] orientation3 = Triangle3D.orientation(triangle);
        double[] orientation4 = Triangle3D.orientation(triangle, 
                ABSOLUTE_ERROR);
        double[] orientation5 = Triangle3D.orientation(point1, point2, point3);
        double[] orientation6 = Triangle3D.orientation(point1, point2, point3,
                ABSOLUTE_ERROR);
        double[] orientation7 = new double[INHOM_COORDS];
        triangle.orientation(orientation7);
        double[] orientation8 = new double[INHOM_COORDS];
        triangle.orientation(orientation8, ABSOLUTE_ERROR);
        double[] orientation9 = new double[INHOM_COORDS];
        Triangle3D.orientation(triangle, orientation9);
        double[] orientation10 = new double[INHOM_COORDS];
        Triangle3D.orientation(triangle, orientation10, ABSOLUTE_ERROR);
        double[] orientation11 = new double[INHOM_COORDS];
        Triangle3D.orientation(point1, point2, point3, orientation11);
        double[] orientation12 = new double[INHOM_COORDS];
    ...
    public void testGetAngleBetweenTriangles() throws CoincidentPointsException {
        ...
        Point3D point1a = new InhomogeneousPoint3D(randomizer.nextDouble(
                ...
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
        Point3D point2a = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
        Point3D point3a = new InhomogeneousPoint3D(randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE), randomizer.nextDouble(
                MIN_RANDOM_VALUE, MAX_RANDOM_VALUE));
        ...
        Triangle3D triangleA = new Triangle3D(point1a, point2a, point3a);
        Triangle3D triangleB = new Triangle3D(point1b, point2b, point3b);
        
        double[] orientationA = triangleA.getOrientation();
        double[] orientationB = triangleB.getOrientation();
        
        double normA = Utils.normF(orientationA);
        double normB = Utils.normF(orientationB);
        
        //compute dot product between orientation vectors
        double dotProduct = orientationA[0] * orientationB[0] +
                orientationA[1] * orientationB[1] +
                orientationA[2] * orientationB[2];
        double cosAngle = dotProduct / (normA * normB);
        
        double expectedAngle = Math.acos(cosAngle);
