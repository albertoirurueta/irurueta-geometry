 ...
 * com.irurueta.geometry.calib3D.DualAbsoluteQuadric
 * 
...
public class DualAbsoluteQuadricTest {
    ...
    public static final double MIN_ASPECT_RATION = 0.5;
    ...
    public static final int IAC_ROWS = 3;
    public static final int IAC_COLS = 3;
    
    public static final int DAQ_ROWS = 4;
    public static final int DAQ_COLS = 4;
