 ...
 * com.irurueta.geometry.calib3d.AlternatingCameraCalibrator
 * 
...
/*        assertEquals(avgK1Error, 0.0, ULTRA_LARGE_ABSOLUTE_ERROR);
        assertEquals(avgK2Error, 0.0, ULTRA_LARGE_ABSOLUTE_ERROR);*/
    ...
    public void testCalibrateQRPatternDistortion() 
            throws LockedException, CalibrationException, NotReadyException, NotSupportedException, DistortionException{
...
/*        assertEquals(avgHorizontalFocalDistanceError, 0.0, VERY_LARGE_ABSOLUTE_ERROR);
        ...
        //check that average distortion parameters error is small enough
/*        assertEquals(avgK1Error, 0.0,LARGE_ABSOLUTE_ERROR);
        assertEquals(avgK2Error, 0.0,LARGE_ABSOLUTE_ERROR);*/
...
/*        assertEquals(avgK1Error, 0.0,LARGE_ABSOLUTE_ERROR);
    ...
    public void onCalibrateStart(CameraCalibrator calibrator) {
        calibrateStart++;
        testLocked((AlternatingCameraCalibrator)calibrator);
    }
    ...
    public void testLocked(AlternatingCameraCalibrator calibrator){
        try{
