 ...
 * com.irurueta.geometry.calib3d.estimators.CameraPoseEstimator
 * 
...
import static com.irurueta.geometry.calib3d.AlternatingCameraCalibratorTest.INHOM_3D_COORDS;
...
public class CameraPoseEstimatorTest {
    ...
    public static final double MIN_RANDOM_VALUE = -0.2; //-1.0; //-1m
    public static final double MAX_RANDOM_VALUE = -0.03; //-0.1; //-10cm
    
    //use a typical focal length for a phone (Samsung Galaxy Note 4)
    public static final double MIN_FOCAL_LENGTH = 1400.0;
    public static final double MAX_FOCAL_LENGTH = 1500.0;
    
    //skewness is always close to 0.0
    public static final double MIN_SKEWNESS = -1e-6;
    public static final double MAX_SKEWNESS = 1e-6;
    
    public static final double MIN_ANGLE_DEGREES = 0.0;
    public static final double MAX_ANGLE_DEGREES = 5.0;
        
    public static final double ABSOLUTE_ERROR = 1e-6;
    public static final double LARGE_ABSOLUTE_ERROR = 1e-5;
    public static final double VERY_LARGE_ABSOLUTE_ERROR = 5e-4;
    
    public static final double STD_ERROR = 0.5;
    ...
    public void testEstimateCirclesWithError() throws AlgebraException, 
            GeometryException, LockedException, NotReadyException, 
