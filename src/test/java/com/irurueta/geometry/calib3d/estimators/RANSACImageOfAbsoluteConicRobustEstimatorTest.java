...
public class RANSACImageOfAbsoluteConicRobustEstimatorTest implements 
    ...
    public static final double LARGE_THRESHOLD = 1e-8;
    ...
    public RANSACImageOfAbsoluteConicRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        ...
        RANSACImageOfAbsoluteConicRobustEstimator estimator =
                new RANSACImageOfAbsoluteConicRobustEstimator();
        ...
        estimator = new RANSACImageOfAbsoluteConicRobustEstimator(this);
        ...
        estimator = new RANSACImageOfAbsoluteConicRobustEstimator(homographies);
        ...
        estimator = null;
        try{
            estimator = new RANSACImageOfAbsoluteConicRobustEstimator(
    ...
    public void testEstimateCirclesPattern() throws 
        ...
        for(int j = 0; j < TIMES; j++){
            ...
            //Estimate IAC
            RANSACImageOfAbsoluteConicRobustEstimator estimator =
                    new RANSACImageOfAbsoluteConicRobustEstimator(homographies, 
                    this);
        ...
        Logger.getLogger(RANSACImageOfAbsoluteConicRobustEstimatorTest.class.getName()).
                log(Level.INFO, msg);
    ...
    public void onEstimateStart(ImageOfAbsoluteConicRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACImageOfAbsoluteConicRobustEstimator)estimator);
    }
