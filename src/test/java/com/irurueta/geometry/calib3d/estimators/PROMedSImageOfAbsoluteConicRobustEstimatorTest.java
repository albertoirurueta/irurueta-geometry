...
public class PROMedSImageOfAbsoluteConicRobustEstimatorTest implements
    ...
    public PROMedSImageOfAbsoluteConicRobustEstimatorTest() {}
    ...
    public void testConstructor(){
        ...
        PROMedSImageOfAbsoluteConicRobustEstimator estimator =
                new PROMedSImageOfAbsoluteConicRobustEstimator();
        ...
        estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(
                homographies);
        ...
        try{
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(
                    (List<Transformation2D>)null, qualityScores);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
        try{
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(
        ...
        try{
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(
                    (List<Transformation2D>)null, qualityScores, this);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
        try{
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(
    ...
    public void testEstimateCirclesPattern() throws 
        ...
        for(int j = 0; j < TIMES; j++){
            ...
            //Estimate IAC
            PROMedSImageOfAbsoluteConicRobustEstimator estimator =
                    new PROMedSImageOfAbsoluteConicRobustEstimator(homographies,
                    qualityScores, this);
        ...
        Logger.getLogger(PROMedSImageOfAbsoluteConicRobustEstimatorTest.class.getName()).
                log(Level.INFO, msg);
