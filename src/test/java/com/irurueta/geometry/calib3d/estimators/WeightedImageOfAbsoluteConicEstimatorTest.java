 ...
 * com.irurueta.geometry.calib3d.estimators.WeightedImageOfAbsoluteConicEstimator
 * 
...
public class WeightedImageOfAbsoluteConicEstimatorTest implements 
    ...
    public void testConstructor(){
        ...
        try{
            estimator = new WeightedImageOfAbsoluteConicEstimator(
                    (List<Transformation2D>)null, weights);
        ...
        try{
            estimator = new WeightedImageOfAbsoluteConicEstimator(
                    (List<Transformation2D>)null, weights, this);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
        try{
            estimator = new WeightedImageOfAbsoluteConicEstimator(homographies, 
    ...
    public void testGetSetHomographiesAndWeightsAndIsReady() 
        ...
        try{
            estimator.setHomographiesAndWeights((List<Transformation2D>)null, 
                    weights);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
        try{
    ...
    public void testEstimatePrincipalPointAtOrigin() 
        ...
        for(int j = 0; j < TIMES; j++){
            ...
            try{
                ...
                if (Math.abs(intrinsic.getHorizontalFocalLength() - intrinsic2.getHorizontalFocalLength()) > VERY_LARGE_ABSOLUTE_ERROR) {
                    continue;
                }
                assertEquals(intrinsic.getHorizontalFocalLength(), 
                        intrinsic2.getHorizontalFocalLength(), 
                        VERY_LARGE_ABSOLUTE_ERROR);
                if (Math.abs(intrinsic.getVerticalFocalLength() - intrinsic2.getVerticalFocalLength()) > VERY_LARGE_ABSOLUTE_ERROR) {
                    continue;
                }
                assertEquals(intrinsic.getVerticalFocalLength(),
                        intrinsic2.getVerticalFocalLength(), 
