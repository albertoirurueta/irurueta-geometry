 ...
 * com.irurueta.geometry.estimators.RANSACRadialDistortionRobustEstimator
 * 
...
public class RANSACRadialDistortionRobustEstimatorTest implements 
    ...
    public void onEstimateStart(RadialDistortionRobustEstimator estimator) {
        estimateStart++;
        testLocked((RANSACRadialDistortionRobustEstimator)estimator);
    }
    ...
    private void testLocked(RANSACRadialDistortionRobustEstimator estimator){
        try{
