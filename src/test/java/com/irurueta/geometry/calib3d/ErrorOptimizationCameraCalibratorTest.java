 ...
 * com.irurueta.geometry.calib3d.ErrorOptimizationCameraCalibrator
 * 
...
import com.irurueta.geometry.calib3d.estimators.LMedSImageOfAbsoluteConicRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.LMedSRadialDistortionRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.MSACImageOfAbsoluteConicRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.MSACRadialDistortionRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.PROMedSImageOfAbsoluteConicRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.PROMedSRadialDistortionRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.PROSACImageOfAbsoluteConicRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.PROSACRadialDistortionRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.RANSACImageOfAbsoluteConicRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.RANSACRadialDistortionRobustEstimator;
...
public class ErrorOptimizationCameraCalibratorTest implements 
    ...
    public static final int MIN_NUM_SAMPLES = 100;
    public static final int MAX_NUM_SAMPLES = 500;
    ...
    public static final double MIN_DISTORTION_PARAM_VALUE = -1e-3;
    public static final double MAX_DISTORTION_PARAM_VALUE = 1e-3;        
    
    public static final double REAL_IAC_THRESHOLD = 1e-8;
    ...
    public ErrorOptimizationCameraCalibratorTest() {}
    ...
    public void testConstructor(){
        ...
        ErrorOptimizationCameraCalibrator calibrator =
                new ErrorOptimizationCameraCalibrator();
        
        //check default values
        assertEquals(calibrator.getLevenbergMarquardtMaxIters(),
                ErrorOptimizationCameraCalibrator.
                DEFAULT_LEVENBERG_MARQUARDT_MAX_ITERS);
        assertEquals(calibrator.getLevenbergMarquardtTolerance(),
                ErrorOptimizationCameraCalibrator.
                DEFAULT_LEVENBERG_MARQUARDT_TOLERANCE, 0.0);
        ...
        calibrator = new ErrorOptimizationCameraCalibrator(pattern, samples);
        ...
        calibrator = null;
        try{
            calibrator = new ErrorOptimizationCameraCalibrator(pattern, 
                    emptySamples);
    ...
    @Test
    public void testGetSetLevenbergMarquardtMaxIters() throws LockedException{
        ErrorOptimizationCameraCalibrator calibrator =
                new ErrorOptimizationCameraCalibrator();
        ...
        //set new value
        calibrator.setLevenbergMarquardtMaxIters(1);
        
        //check correctness
        assertEquals(calibrator.getLevenbergMarquardtMaxIters(), 1);
        
        //Force IllegalArgumentException
        try{
            calibrator.setLevenbergMarquardtMaxIters(0);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
    }
    
    @Test
    public void testGetSetLevenbergMarquardtTolerance() throws LockedException{
        ErrorOptimizationCameraCalibrator calibrator =
                new ErrorOptimizationCameraCalibrator();
        ...
        //set new value
        calibrator.setLevenbergMarquardtTolerance(1.0);
        
        //check correctness
        assertEquals(calibrator.getLevenbergMarquardtTolerance(), 1.0, 0.0);
        
        //Force IllegalArgumentException
        try{
            calibrator.setLevenbergMarquardtTolerance(0.0);
            fail("IllegalArgumentException expected but not thrown");
        }catch(IllegalArgumentException e){}
    }
    ...
    public void testCalibrateCirclesPatternNoDistortion() 
        ...
        for(int j = 0; j < TIMES; j++){
            ...
            for(int i = 0; i < numSamples; i++){
                if(samples.get(i).getHomography() != null){
                    ...
                    if(samples.get(i).getCamera() != null) estimatedCams++;
                }
            }
        ...
        Logger.getLogger(ErrorOptimizationCameraCalibratorTest.class.getName()).
                log(Level.INFO, msg);        
    }
...
/*            assertEquals(intrinsic.getHorizontalFocalLength(), 
    ...
    public void testCalibrateCirclesPatternDistortion() 
        ...
        for(int j = 0; j < TIMES; j++){
            ...
            /*assertEquals(distortion.getK1(), distortion2.getK1(), 
                    VERY_LARGE_ABSOLUTE_ERROR);
            assertEquals(distortion.getK2(), distortion2.getK2(),
                    VERY_LARGE_ABSOLUTE_ERROR);*/
        ...
        //check that average error of intrinsic parameters is small enough
        assertEquals(avgHorizontalFocalDistanceError, 0.0, 6.0*VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(avgVerticalFocalDistanceError, 0.0, 6.0*VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(avgSkewnessError, 0.0, VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(avgHorizontalPrincipalPointError, 0.0, VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(avgVerticalPrincipalPointError, 0.0, VERY_LARGE_ABSOLUTE_ERROR);
...
//        assertTrue(Math.abs(k1) > Math.abs(k2));
    ...
    public void onCalibrateStart(CameraCalibrator calibrator) {
        calibrateStart++;
        testLocked((ErrorOptimizationCameraCalibrator)calibrator);
    }
    ...
    public void testLocked(ErrorOptimizationCameraCalibrator calibrator){
        try{
            calibrator.setLevenbergMarquardtMaxIters(1);
