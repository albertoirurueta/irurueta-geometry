...
public class PinholeCameraTest {
    ...
    public void testConstructors() throws WrongSizeException, RotationException,
        ...
        Matrix intrinsicMatrix = intrinsic.getInternalMatrix();
        
        MatrixRotation3D rotation = new MatrixRotation3D(alphaEuler, betaEuler, 
                gammaEuler);
        Matrix rotationMatrix = rotation.getInternalMatrix();
        
        double[] axis = rotation.getRotationAxis();
        double theta = rotation.getRotationAngle();
        
        //image of world origin
        double[] originImageArray = new double[INHOM_2D_COORDS];
        randomizer.fill(originImageArray, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        InhomogeneousPoint2D originImage = new InhomogeneousPoint2D(
                originImageArray);
        ...
        Point2D originImage2 = camera.getImageOfWorldOrigin();
        ...
        Matrix p4 = Mp.multiplyAndReturnNew(inhomCenter).
        ...
        Matrix homCenter = new Matrix(PINHOLE_CAMERA_COLS, 1);
        ...
        //create 4 2D lines
        Line2D line2D1 = new Line2D(randomizer.nextDouble(MIN_RANDOM_LINE_VALUE,
        ...
        Line2D line2D2 = new Line2D(randomizer.nextDouble(MIN_RANDOM_LINE_VALUE,
                ...
                randomizer.nextDouble(MIN_RANDOM_LINE_VALUE, 
                MAX_RANDOM_LINE_VALUE));
        Line2D line2D3 = new Line2D(randomizer.nextDouble(MIN_RANDOM_LINE_VALUE,
                MAX_RANDOM_LINE_VALUE), 
                randomizer.nextDouble(MIN_RANDOM_LINE_VALUE, 
                MAX_RANDOM_LINE_VALUE), 
                randomizer.nextDouble(MIN_RANDOM_LINE_VALUE, 
                MAX_RANDOM_LINE_VALUE));
        Line2D line2D4 = new Line2D(randomizer.nextDouble(MIN_RANDOM_LINE_VALUE,
                MAX_RANDOM_LINE_VALUE), 
                randomizer.nextDouble(MIN_RANDOM_LINE_VALUE, 
                MAX_RANDOM_LINE_VALUE), 
                randomizer.nextDouble(MIN_RANDOM_LINE_VALUE, 
        ...
        Plane plane1 = camera.backProject(line2D1);
        ...
        DLTLinePlaneCorrespondencePinholeCameraEstimator estimator2 = 
    ...
    public void testProjectPoints() throws WrongSizeException {
        ...
        for (int i = 0; i < nPoints; i++) {
            ...
            Point3D point = new HomogeneousPoint3D(pointArray);
        ...
        for (int i = 0; i < nPoints; i++) {
            ...
            imagePointListMatrix.getSubmatrixAsArray(i, 0, i, 
                    ...
                    pointArray);
            Point2D point = new HomogeneousPoint2D(pointArray);
            imagePointList.add(point);
        }
        
        //list of image points to be tested
        List<Point2D> imagePointList2 = camera.project(worldPointList);
        
        assertEquals(imagePointList2.size(), nPoints);
        assertEquals(imagePointList.size(), nPoints);
        
        Iterator<Point2D> iterator = imagePointList.iterator();
        Iterator<Point2D> iterator2 = imagePointList2.iterator();
        Iterator<Point3D> iteratorWorld = worldPointList.iterator();
        ...
        double[] homWorldPointArray = new double[
                Point3D.POINT3D_HOMOGENEOUS_COORDINATES_LENGTH];
    ...
    public void testBackProjectLines() throws WrongSizeException, 
        ...
        double[] lineArray = new double[HOM_2D_COORDS];
        randomizer.fill(lineArray, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        Matrix lineMatrix = Matrix.newFromArray(lineArray, true);
        
        Line2D line = new Line2D(lineArray);
        
        Matrix transCameraMatrix = cameraMatrix.transposeAndReturnNew();
        
        Matrix planeMatrix = transCameraMatrix.multiplyAndReturnNew(
                lineMatrix);
        ...
        Matrix a = planeMatrix.transposeAndReturnNew();
        ...
        HomogeneousPoint3D worldPoint1 = new HomogeneousPoint3D(
                V.getElementAt(0, 1), V.getElementAt(1, 1), 
                V.getElementAt(2, 1), V.getElementAt(3, 1));
        HomogeneousPoint3D worldPoint2 = new HomogeneousPoint3D(
                V.getElementAt(0, 2), V.getElementAt(1, 2), 
                V.getElementAt(2, 2), V.getElementAt(3, 2));
        HomogeneousPoint3D worldPoint3 = new HomogeneousPoint3D(
        ...
        Point2D imagePoint1 = camera.project(worldPoint1);
        Point2D imagePoint2 = camera.project(worldPoint2);
        Point2D imagePoint3 = camera.project(worldPoint3);
    ...
    public void testBackprojectPoints() throws CameraException {
        ...
        double[] worldPointArray = new double[HOM_3D_COORDS];
        randomizer.fill(worldPointArray, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        HomogeneousPoint3D worldPoint = new HomogeneousPoint3D(worldPointArray);
        ...
        Point3D rayOfLight = camera.backProject(imagePoint);
        ...
        List<Point2D> imagePointList = camera.project(worldPointList);
        
        //back project image points to obtain a list of world points containing
        //rays of lisght
        List<Point3D> worldPointList2 = camera.backProjectPoints(
                imagePointList);
        
        //project again to ensure that projected rays of light produce the same
        //image points
        List<Point2D> imagePointList2 = camera.project(worldPointList2);
    ...
    public void testNormalize() throws WrongSizeException {
        ...
        //normalize and copy
        Matrix cameraMatrix2 = cameraMatrix.multiplyByScalarAndReturnNew(
                1.0 / norm);
    ...
    public void testCameraSign() throws WrongSizeException, DecomposerException, 
        ...
        double cameraSign = (detMp > 0.0) ? 1.0 : -1.0;
        double cameraSign2 = camera.getCameraSign();
        
        assertEquals(cameraSign, cameraSign2, ABSOLUTE_ERROR);
        
        //set threshold equal to detMp
        double cameraSign3 = camera.getCameraSign(detMp);
    ...
    public void testGetSetInternalMatrix() throws WrongSizeException {
        ...
        Matrix cameraMatrix2 = Matrix.createWithUniformRandomValues(
                PINHOLE_CAMERA_ROWS, PINHOLE_CAMERA_COLS, MIN_RANDOM_VALUE, 
                MAX_RANDOM_VALUE);
    ...
    public void testGetSetIntrinsicsAndAvailability() throws CameraException, 
        ...
        PinholeCameraIntrinsicParameters K2 = camera.getIntrinsicParameters();
    ...
    public void testRotate() throws WrongSizeException, CameraException, 
        ...
        double norm = com.irurueta.algebra.Utils.normF(axisMatrix);
        axisMatrix.multiplyByScalar(1.0 / norm);
        
        double[] axisArray = axisMatrix.toArray();
        ...
        Rotation3D rotation1 = new MatrixRotation3D(axisArray, theta1);
        Rotation3D rotation2 = new MatrixRotation3D(axisArray, theta2);
        ...
        //obtian current rotation
        Rotation3D rotation3 = camera.getCameraRotation();
        
        //obtain current axis and rotation angle
        double[] axis3 = rotation3.getRotationAxis();
        double theta3 = rotation3.getRotationAngle();
        
        //check that rotation axis is equal up to sign
        double scaleX = axisArray[0] / axis3[0];
        double scaleY = axisArray[1] / axis3[1];
        double scaleZ = axisArray[2] / axis3[2];
    ...
    public void testPointAt() throws WrongSizeException, CameraException, 
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            Matrix pointAtMatrix = Matrix.createWithUniformRandomValues(
                    INHOM_3D_COORDS, 1, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
            InhomogeneousPoint3D pointAt = new InhomogeneousPoint3D(
            ...
            double[] diffArray = new double[INHOM_3D_COORDS];
            ...
            double norm = com.irurueta.algebra.Utils.normF(diffArray);
            ArrayUtils.multiplyByScalar(diffArray, 1.0 / norm, diffArray);

            double scaleX = diffArray[0] / principalAxis[0];
            double scaleY = diffArray[1] / principalAxis[1];
            double scaleZ = diffArray[2] / principalAxis[2];
    ...
    public void testGetSetCameraCenterAvailabilityAndComputeCameraCenterSVDDetAndFinite() 
        ...
        Matrix cameraCenterMatrix2 = Matrix.createWithUniformRandomValues(
                INHOM_3D_COORDS, 1, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        InhomogeneousPoint3D cameraCenter2 = new InhomogeneousPoint3D(
        ...
        PinholeCameraIntrinsicParameters intrinsic2 =
                camera.getIntrinsicParameters();
        Point3D cameraCenter3 = camera.getCameraCenter();
        
        //also compute center without decomposition using different methods
        Point3D cameraCenterSVD = camera.computeCameraCenterSVD();
        Point3D cameraCenterDet = camera.computeCameraCenterDet();
        Point3D cameraCenterFinite = camera.computeCameraCenterFiniteCamera();
        
        //check that rotation and intrinsics have'nt changed while
    ...
    public void testSetIntrinsicAndExtrinsicParameters() 
        ...
        Matrix worldOriginMatrix = Matrix.createWithUniformRandomValues(
                HOM_2D_COORDS, 1, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        HomogeneousPoint2D imageOfWorldOrigin = new HomogeneousPoint2D(
        ...
        Point2D imageOfWorldOrigin2 = camera.getImageOfWorldOrigin();
        ...
        //set new intrinsics and extrinsics using camera center
        ...
        //check correctness of intrinsic parameters
        PinholeCameraIntrinsicParameters intrinsic4 =
                camera.getIntrinsicParameters();
        ...
        //check correctness of rotation
        Rotation3D rotation4 = camera.getCameraRotation();
    ...
    public void testGetSetVanishingPointsAndImageOfWorldOrigin() 
        ...
        PinholeCamera camera = new PinholeCamera(internalMatrix);
        
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        
        //test get set x-axis vanishing point
        Point2D xAxisVanishingPoint = camera.getXAxisVanishingPoint();
        ...
        Point2D yAxisVanishingPoint = camera.getYAxisVanishingPoint();
        ...
        Point2D zAxisVanishingPoint = camera.getZAxisVanishingPoint();
        ...
        Point2D imageOfWorldOrigin = camera.getImageOfWorldOrigin();
    ...
    public void testGetSetHorizontalVerticalAndPrincipalPlanesAndAxis() 
        ...
        Plane verticalAxisPlane = camera.getVerticalAxisPlane();
        ...
        Plane horizontalAxisPlane = camera.getHorizontalAxisPlane();
        ...
        Plane principalPlane = camera.getPrincipalPlane();
    ...
    public void testGetPrincipalPoint() throws WrongSizeException {
        ...
        //get principal point
        Point2D principalPoint = camera.getPrincipalPoint();
    ...
    public void testGetAndFixCameraSign() throws WrongSizeException, 
        ...
        Matrix Mp = internalMatrix.getSubmatrix(0, 0, 2, 2);
        double detMp = com.irurueta.algebra.Utils.det(Mp);
        double cameraSign = (detMp > 0.0) ? 1.0 : -1.0;
    ...
    public void testGetDepthCheiralityAndFrontOfCamera() 
        ...
        Plane principalPlane = camera.getPrincipalPlane();
        Matrix principalPlaneMatrix = new Matrix(1, HOM_3D_COORDS);
        ...
        HomogeneousPoint3D planePoint1 = new HomogeneousPoint3D(
                V.getElementAt(0, 1), V.getElementAt(1, 1),
                V.getElementAt(2, 1), V.getElementAt(3, 1));
        HomogeneousPoint3D planePoint2 = new HomogeneousPoint3D(
                V.getElementAt(0, 2), V.getElementAt(1, 2),
                V.getElementAt(2, 2), V.getElementAt(3, 2));
        HomogeneousPoint3D planePoint3 = new HomogeneousPoint3D(
                V.getElementAt(0, 3), V.getElementAt(1, 3),
                V.getElementAt(2, 3), V.getElementAt(3, 3));
        ...
        //coordinates some positiveDepth or negtiveDepth value on the principal
        //axis direction (which is normalized)
        InhomogeneousPoint3D frontPoint1 = new InhomogeneousPoint3D(
        ...
        InhomogeneousPoint3D frontPoint2 = new InhomogeneousPoint3D(
        ...
        InhomogeneousPoint3D frontPoint3 = new InhomogeneousPoint3D(
        ...
        InhomogeneousPoint3D backPoint1 = new InhomogeneousPoint3D(
        ...
        InhomogeneousPoint3D backPoint2 = new InhomogeneousPoint3D(
        ...
        InhomogeneousPoint3D backPoint3 = new InhomogeneousPoint3D(
    ...
    public void testGetDepthsCheiralitiesAndInFrontOfCamera() 
        ...
        List<Double> depths = camera.getDepths(worldPointList);
        ...
        Iterator<Point3D> pointsIterator = worldPointList.iterator();
        Iterator<Double> depthsIterator = depths.iterator();
        Iterator<Double> cheiralitiesIterator = cheiralities.iterator();
        Iterator<Boolean> frontsIterator = fronts.iterator();
        Iterator<Boolean> fronts2Iterator = fronts2.iterator();
        Point3D point;
        Double depth, cheirality;
    ...
    public void testIsNormalized() throws WrongSizeException, CameraException {
        ...
        double[] worldOriginArray = new double[HOM_2D_COORDS];
        ...
        double y = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        double w = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        Point2D xAxisVanishingPoint = new HomogeneousPoint2D(x, y, w);
        x = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        y = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        w = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);        
        Point2D yAxisVanishingPoint = new HomogeneousPoint2D(x, y, w);
        x = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        y = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        w = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);                
        Point2D zAxisVanishingPoint = new HomogeneousPoint2D(x, y, w);
        ...
        double c = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        double d = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        Plane verticalAxisPlane = new Plane(a, b, c, d);
        
        a = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        b = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        c = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        d = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        Plane horizontalAxisPlane = new Plane(a, b, c, d);

        a = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        b = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        c = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        d = randomizer.nextDouble(MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        Plane principalPlane = new Plane(a, b, c, d);
        ...
        double[] pointAtArray = new double[INHOM_3D_COORDS];
        randomizer.fill(pointAtArray, MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
        InhomogeneousPoint3D pointAt = new InhomogeneousPoint3D(pointAtArray);
    ...
    public void testProjectBackProjectQuadricAndConic() 
        ...
        Conic conic = new Conic(point1, point2, point3, point4, point5);
        ...
        Quadric quadric = camera.backProject(conic);
        
        //backproject planes of dual conic
        Point3D point1b = camera.backProject(point1);
        Point3D point2b = camera.backProject(point2);
        Point3D point3b = camera.backProject(point3);
        Point3D point4b = camera.backProject(point4);
        Point3D point5b = camera.backProject(point5);
    ...
    /*
    @Test
    public void testSetFromPointCorrespondences(){
        //TODO: finish
    }
    
    @Test
    public void testSetFromLineAndPlaneCorrespondences(){
        //TODO: finish
    }*/
}
