...
public class LMedSRobustSinglePoint3DTriangulatorTest implements
    ...
    private static final double STOP_THRESHOLD = 1e-8;
   ...
   @Test
    ...
    public void onTriangulateStart(
        ...
        triangulateStart++;
        checkLocked((LMedSRobustSinglePoint3DTriangulator)triangulator);
    }
    ...
    private void checkLocked(LMedSRobustSinglePoint3DTriangulator triangulator) {
        try {
            triangulator.setStopThreshold(0.5);
