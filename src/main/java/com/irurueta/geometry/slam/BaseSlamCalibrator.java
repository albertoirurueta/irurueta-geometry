 ...
 * com.irurueta.geometry.slam.BaseSlamCalibrator
 * 
...
public abstract class BaseSlamCalibrator<D extends BaseCalibrationData> 
     ...
     * @return true if calibrator has finished, false otherwise.
     */
    protected boolean updateSample() {
