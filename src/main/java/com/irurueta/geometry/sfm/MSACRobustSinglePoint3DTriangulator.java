 ...
 * com.irurueta.geometry.sfm.MSAcRobustSinglePoint3DTriangulator
 * 
 ...
 */
public class MSACRobustSinglePoint3DTriangulator extends 
     ...
     */
    public MSACRobustSinglePoint3DTriangulator(List<Point2D> points, 
            ...
            public void onEstimateStart(RobustEstimator<Point3D> estimator) {
                if(mListener != null){
                    mListener.onTriangulateStart(
                            MSACRobustSinglePoint3DTriangulator.this);
                }
            }
