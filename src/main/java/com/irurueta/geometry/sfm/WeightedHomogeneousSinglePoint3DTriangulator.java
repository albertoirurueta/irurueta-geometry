...
import static com.irurueta.geometry.sfm.SinglePoint3DTriangulator.MIN_REQUIRED_VIEWS;
import com.irurueta.sorting.SortingException;
import java.util.List;

/**
 * Triangulates matched 2D points into a single 3D one by using 2D point
 * correspondencs on different views along with the corresponding cameras on
 * each of those views by finding a weighted solution to homogeneous systems
 * of equations.
 * Eeach equation on the linear system of equations is weigthed using provided
...
public class WeightedHomogeneousSinglePoint3DTriangulator extends 
    ...
    /**
     * Specifies wether weights are sorted by so that largest weighted
     * correspondences are used first
    ...
    protected void triangulate(List<Point2D> points2D, 
        ...
        try{
            ...
            Matrix a = new Matrix(2 * numViews, 2 * MIN_REQUIRED_VIEWS);
