...
public abstract class Transformation2D {
    ...
    public Point2D transformAndReturnNew(Point2D inputPoint){
        Point2D outputPoint = Point2D.create();
     ...
     */
    public void transformPoints(List<Point2D> inputPoints, 
     ...
     */
    public DualConic transformAndReturnNew(DualConic inputDualConic) 
            throws NonSymmetricMatrixException, AlgebraException {
        DualConic outputDualConic = new DualConic();
     ...
     * of numerical instabilities.
     */
    public void transform(DualConic dualConic) 
            throws NonSymmetricMatrixException, AlgebraException {
     ...
     * of numerical instabilities.
     */
    public abstract void transform(DualConic inputDualConic, 
            DualConic outputDualConic) throws NonSymmetricMatrixException,
            AlgebraException;
     ...
     * of numerical instabilities.
     */
    public Line2D transformAndReturnNew(Line2D inputLine) 
            throws AlgebraException {
        Line2D outputLine = new Line2D();
     ...
     * numerical instabilities.
     */
    public void transform(Line2D line) throws AlgebraException {
        transform(line, line);
    }
     ...
     * of numerical instabilities.
     */
    public abstract void transform(Line2D inputLine, Line2D outputLine) 
            throws AlgebraException;
     ...
     * of numerical instabilities.
     */
    public void transformLines(List<Line2D> inputLines, 
    ...
    public Polygon2D transformAndReturnNew(Polygon2D inputPolygon) {
        List<Point2D> outVertices = transformPointsAndReturnNew(
    ...
    public Triangle2D transformAndReturnNew(Triangle2D inputTriangle) {
        Point2D vertex1 = Transformation2D.this.transformAndReturnNew(
                inputTriangle.getVertex1());
        Point2D vertex2 = Transformation2D.this.transformAndReturnNew(
                inputTriangle.getVertex2());
        Point2D vertex3 = Transformation2D.this.transformAndReturnNew(
