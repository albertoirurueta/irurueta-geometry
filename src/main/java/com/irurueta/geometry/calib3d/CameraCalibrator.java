...
import com.irurueta.geometry.calib3d.estimators.ImageOfAbsoluteConicRobustEstimator;
import com.irurueta.geometry.calib3d.estimators.ImageOfAbsoluteConicRobustEstimatorListener;
...
import com.irurueta.geometry.estimators.ProjectiveTransformation2DRobustEstimatorListener;
...
public abstract class CameraCalibrator {
    ...
    public static final RobustEstimatorMethod DEFAULT_HOMOGRAPHY_METHOD =
            RobustEstimatorMethod.PROSAC; //.LMedS;
    ...
    protected void estimateIntrinsicParameters(
        ...
        mHomographies = new ArrayList<Transformation2D>(sampleSize);
