...
public class PROMedSEuclideanTransformation3DRobustEstimator extends EuclideanTransformation3DRobustEstimator {
     ...
     */
    public PROMedSEuclideanTransformation3DRobustEstimator(final double[] qualityScores) {
        super();
        stopThreshold = DEFAULT_STOP_THRESHOLD;
     ...
     */
    public PROMedSEuclideanTransformation3DRobustEstimator(final boolean weakMinimumSizeAllowed) {
    ...
    public EuclideanTransformation3D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new PROMedSRobustEstimator<>(
                new PROMedSRobustEstimatorListener<EuclideanTransformation3D>() {
                    ...
                    @Override
                    public boolean isReady() {
                        return PROMedSEuclideanTransformation3DRobustEstimator.this.isReady();
                    }

                    @Override
                    public void onEstimateStart(final RobustEstimator<EuclideanTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateStart(PROMedSEuclideanTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(final RobustEstimator<EuclideanTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateEnd(PROMedSEuclideanTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(
                        ...
                        if (listener != null) {
                            listener.onEstimateNextIteration(
                                    PROMedSEuclideanTransformation3DRobustEstimator.this, iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(
                        ...
                        if (listener != null) {
                            listener.onEstimateProgressChange(
                                    PROMedSEuclideanTransformation3DRobustEstimator.this, progress);
                        }
                    }
