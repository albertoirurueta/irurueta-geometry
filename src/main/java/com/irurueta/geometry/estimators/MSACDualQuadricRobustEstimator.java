...
public class MSACDualQuadricRobustEstimator extends DualQuadricRobustEstimator {
     ...
     */
    public MSACDualQuadricRobustEstimator(final DualQuadricRobustEstimatorListener listener) {
        super(listener);
        threshold = DEFAULT_THRESHOLD;
    }
    ...
    public DualQuadric estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new MSACRobustEstimator<>(new MSACRobustEstimatorListener<DualQuadric>() {
            ...
            public void onEstimateStart(final RobustEstimator<DualQuadric> estimator) {
                if (listener != null) {
                    listener.onEstimateStart(MSACDualQuadricRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(final RobustEstimator<DualQuadric> estimator) {
                if (listener != null) {
                    listener.onEstimateEnd(MSACDualQuadricRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(final RobustEstimator<DualQuadric> estimator, final int iteration) {
                if (listener != null) {
                    listener.onEstimateNextIteration(MSACDualQuadricRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(final RobustEstimator<DualQuadric> estimator, final float progress) {
                if (listener != null) {
                    listener.onEstimateProgressChange(MSACDualQuadricRobustEstimator.this, progress);
                }
            }
        });
