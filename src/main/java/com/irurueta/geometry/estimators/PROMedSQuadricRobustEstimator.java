...
public class PROMedSQuadricRobustEstimator extends QuadricRobustEstimator{
    ...
    public Quadric estimate() throws LockedException, NotReadyException, 
        ...
        PROMedSRobustEstimator<Quadric> innerEstimator =
                new PROMedSRobustEstimator<Quadric>(
                        new PROMedSRobustEstimatorListener<Quadric>(){
            ...
            public void onEstimateStart(RobustEstimator<Quadric> estimator) {
                if(mListener != null){
                    mListener.onEstimateStart(
                            PROMedSQuadricRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(RobustEstimator<Quadric> estimator) {
                if(mListener != null){
                    mListener.onEstimateEnd(PROMedSQuadricRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(
                ...
                if(mListener != null){
                    mListener.onEstimateNextIteration(
                            PROMedSQuadricRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(
                ...
                if(mListener != null){
                    mListener.onEstimateProgressChange(
                            PROMedSQuadricRobustEstimator.this, progress);
                }
            }
