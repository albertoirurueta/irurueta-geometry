...
public class RANSACMetricTransformation3DRobustEstimator extends MetricTransformation3DRobustEstimator {
     ...
     * Constructor.
     */
    public RANSACMetricTransformation3DRobustEstimator() {
        super();
     ...
     */
    public RANSACMetricTransformation3DRobustEstimator(final MetricTransformation3DRobustEstimatorListener listener) {
        super(listener);
        threshold = DEFAULT_THRESHOLD;
        computeAndKeepInliers = DEFAULT_COMPUTE_AND_KEEP_INLIERS;
        computeAndKeepResiduals = DEFAULT_COMPUTE_AND_KEEP_RESIDUALS;
     ...
     */
    public RANSACMetricTransformation3DRobustEstimator(final boolean weakMinimumSizeAllowed) {
    ...
    public MetricTransformation3D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new RANSACRobustEstimator<>(
                new RANSACRobustEstimatorListener<MetricTransformation3D>() {
                    ...
                    public boolean isReady() {
                        return RANSACMetricTransformation3DRobustEstimator.this.isReady();
                    }

                    @Override
                    public void onEstimateStart(final RobustEstimator<MetricTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateStart(RANSACMetricTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(final RobustEstimator<MetricTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateEnd(RANSACMetricTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(
                        ...
                        if (listener != null) {
                            listener.onEstimateNextIteration(
                                    RANSACMetricTransformation3DRobustEstimator.this, iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(
                        ...
                        if (listener != null) {
                            listener.onEstimateProgressChange(
                                    RANSACMetricTransformation3DRobustEstimator.this, progress);
                        }
                    }
                });
