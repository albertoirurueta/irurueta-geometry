/**
 * @file
 * This file contains implementastion of
...
public abstract class DualQuadricRobustEstimator {
     ...
     */
    public void setListener(DualQuadricRobustEstimatorListener listener)
     ...
     */
    public static DualQuadricRobustEstimator create(RobustEstimatorMethod method){
        switch(method){
            case LMedS:
    ...
    protected double residual(DualQuadric dq, Plane plane){
        ...
        try{
            ...
            Matrix locusMatrix = mTestPlane.transposeAndReturnNew();
