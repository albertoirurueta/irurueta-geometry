 ...
 */
public class LMedSEuclideanTransformation3DRobustEstimator extends EuclideanTransformation3DRobustEstimator {
     ...
     */
    public LMedSEuclideanTransformation3DRobustEstimator(final boolean weakMinimumSizeAllowed) {
        ...
        final var innerEstimator = new LMedSRobustEstimator<>(
                new LMedSRobustEstimatorListener<EuclideanTransformation3D>() {
                    ...
                    public boolean isReady() {
                        return LMedSEuclideanTransformation3DRobustEstimator.this.isReady();
                    }

                    @Override
                    public void onEstimateStart(final RobustEstimator<EuclideanTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateStart(LMedSEuclideanTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(final RobustEstimator<EuclideanTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateEnd(LMedSEuclideanTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(
                        ...
                        if (listener != null) {
                            listener.onEstimateNextIteration(
                                    LMedSEuclideanTransformation3DRobustEstimator.this, iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(
                        ...
                        if (listener != null) {
                            listener.onEstimateProgressChange(
                                    LMedSEuclideanTransformation3DRobustEstimator.this, progress);
                        }
                    }
                });
