 ...
 * com.irurueta.geometry.estimators.PROMedSLinePlaneCorrespondencePinholeCameraRobustEstimator
 * 
    ...
    public PinholeCamera estimate() throws LockedException, NotReadyException, 
        ...
        PROMedSRobustEstimator<PinholeCamera> innerEstimator =
            ...
            public void onEstimateStart(
                ...
                if (mListener != null) {
                    mListener.onEstimateStart(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(
                    RobustEstimator<PinholeCamera> estimator) {
                if (mListener != null) {
                    mListener.onEstimateEnd(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(
                ...
                if (mListener != null) {
                    mListener.onEstimateNextIteration(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.this, 
                            iteration);
                }
            }
            ...
            public void onEstimateProgressChange(
                ...
                if (mListener != null) {
                    mListener.onEstimateProgressChange(PROMedSDLTLinePlaneCorrespondencePinholeCameraRobustEstimator.this, 
                            progress);
                }
            }
