...
public class PROMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator
     ...
     */
    public PROMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator(final double[] qualityScores) {
        super();
        stopThreshold = DEFAULT_STOP_THRESHOLD;
    ...
    public AffineTransformation3D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new PROMedSRobustEstimator<>(
                new PROMedSRobustEstimatorListener<AffineTransformation3D>() {
                    ...
                    @Override
                    public boolean isReady() {
                        return PROMedSPlaneCorrespondenceAffineTransformation3DRobustEstimator.this.isReady();
                    }
