 ...
 * com.irurueta.geometry.estimators.LMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator
 * 
 ...
 */
public class LMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator 
    ...
    public ProjectiveTransformation3D estimate() throws LockedException, 
        ...
        LMedSRobustEstimator<ProjectiveTransformation3D> innerEstimator =
                new LMedSRobustEstimator<ProjectiveTransformation3D>(
            ...
            public void onEstimateStart(
                ...
                if(mListener != null){
                    mListener.onEstimateStart(LMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(
                    RobustEstimator<ProjectiveTransformation3D> estimator) {
                if(mListener != null){
                    mListener.onEstimateEnd(LMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator.this);
                }
            }
