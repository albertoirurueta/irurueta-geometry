...
public class PROSACPointCorrespondenceAffineTransformation3DRobustEstimator
     ...
     */
    public PROSACPointCorrespondenceAffineTransformation3DRobustEstimator(final double[] qualityScores) {
        super();
        threshold = DEFAULT_THRESHOLD;
    ...
    public AffineTransformation3D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new PROSACRobustEstimator<>(
                new PROSACRobustEstimatorListener<AffineTransformation3D>() {
                    ...
                    @Override
                    public boolean isReady() {
                        return PROSACPointCorrespondenceAffineTransformation3DRobustEstimator.this.isReady();
                    }
