...
public class LMedSLine2DRobustEstimator extends Line2DRobustEstimator {
     ...
     */
    public LMedSLine2DRobustEstimator(final List<Point2D> points) {
        super(points);
        stopThreshold = DEFAULT_STOP_THRESHOLD;
    }
     ...
     */
    public LMedSLine2DRobustEstimator(final Line2DRobustEstimatorListener listener) {
        super(listener);
        stopThreshold = DEFAULT_STOP_THRESHOLD;
    }
     ...
     *                                  a size greater or equal than MINIMUM_SIZE.
     */
    public LMedSLine2DRobustEstimator(final Line2DRobustEstimatorListener listener, final List<Point2D> points) {
    ...
    public Line2D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new LMedSRobustEstimator<>(new LMedSRobustEstimatorListener<Line2D>() {
            ...
            public void onEstimateStart(final RobustEstimator<Line2D> estimator) {
                if (listener != null) {
                    listener.onEstimateStart(LMedSLine2DRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(final RobustEstimator<Line2D> estimator) {
                if (listener != null) {
                    listener.onEstimateEnd(LMedSLine2DRobustEstimator.this);
                }
            }
