...
public abstract class ProjectiveTransformation3DRobustEstimator {
     ...
     */
    protected ProjectiveTransformation3DRobustEstimatorListener listener;
     ...
     * Constructor.
     */
    protected ProjectiveTransformation3DRobustEstimator() {
     ...
     */
    public void setListener(final ProjectiveTransformation3DRobustEstimatorListener listener) throws LockedException {
        if (isLocked()) {
     ...
     */
    public abstract ProjectiveTransformation3D estimate() throws LockedException, NotReadyException,
    ...
    public static ProjectiveTransformation3DRobustEstimator createFromPoints(
        ...
        return PointCorrespondenceProjectiveTransformation3DRobustEstimator.create(inputPoints, outputPoints, method);
    }
    ...
    public static ProjectiveTransformation3DRobustEstimator createFromPoints(
        ...
        return PointCorrespondenceProjectiveTransformation3DRobustEstimator.create(listener, inputPoints, outputPoints,
                method);
    }
    ...
    public static ProjectiveTransformation3DRobustEstimator createFromPoints(
        ...
        return PointCorrespondenceProjectiveTransformation3DRobustEstimator.create(inputPoints, outputPoints,
    ...
    public static ProjectiveTransformation3DRobustEstimator createFromPlanes(
        ...
        return PlaneCorrespondenceProjectiveTransformation3DRobustEstimator.create(inputPlanes, outputPlanes, method);
    }
     ...
     */
    public static ProjectiveTransformation3DRobustEstimator createFromPlanes(
            final ProjectiveTransformation3DRobustEstimatorListener listener, final List<Plane> inputPlanes,
            final List<Plane> outputPlanes, final RobustEstimatorMethod method) {
        return PlaneCorrespondenceProjectiveTransformation3DRobustEstimator.create(listener, inputPlanes, outputPlanes,
                method);
    }
    ...
    public static ProjectiveTransformation3DRobustEstimator createFromPlanes(
            ...
            final RobustEstimatorMethod method) {
        return PlaneCorrespondenceProjectiveTransformation3DRobustEstimator.create(inputPlanes, outputPlanes,
                qualityScores, method);
    }
