...
public interface CircleRobustEstimatorListener {
     ...
     */
    void onEstimateStart(CircleRobustEstimator estimator);
    
    /**
     * Called when estimation ends.
     * @param estimator reference to robust estimator.
     */
    void onEstimateEnd(CircleRobustEstimator estimator);
     ...
     */
    void onEstimateNextIteration(CircleRobustEstimator estimator,
            int iteration);
     ...
     * and 1.0.
     */
    void onEstimateProgressChange(CircleRobustEstimator estimator,
            float progress);
}
