...
public interface SphereRobustEstimatorListener {
     ...
     */
    void onEstimateNextIteration(final SphereRobustEstimator estimator, final int iteration);
     ...
     *                  and 1.0.
     */
    void onEstimateProgressChange(final SphereRobustEstimator estimator, final float progress);
}
