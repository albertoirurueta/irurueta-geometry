...
/**
 * Finds the best circle for provided collection of 2D points using RANSAC 
 * algorithm
 */
public class RANSACCircleRobustEstimator extends CircleRobustEstimator{
    /**
     ...
     */
    public RANSACCircleRobustEstimator(List<Point2D> points) 
     ...
     */
    public RANSACCircleRobustEstimator(CircleRobustEstimatorListener listener){
        super(listener);
        mThreshold = DEFAULT_THRESHOLD;
    }
    ...
    public Circle estimate() throws LockedException, NotReadyException, 
        ...
        RANSACRobustEstimator<Circle> innerEstimator =
                new RANSACRobustEstimator<Circle>(
