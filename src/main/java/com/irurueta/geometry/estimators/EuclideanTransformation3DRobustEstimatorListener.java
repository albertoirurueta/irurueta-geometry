...
public interface EuclideanTransformation3DRobustEstimatorListener {
     ...
     */
    void onEstimateNextIteration(final EuclideanTransformation3DRobustEstimator estimator, final int iteration);
     ...
     * and 1.0.
     */
    void onEstimateProgressChange(final EuclideanTransformation3DRobustEstimator estimator, final float progress);
}
