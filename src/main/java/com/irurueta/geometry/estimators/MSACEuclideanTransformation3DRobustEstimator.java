...
public class MSACEuclideanTransformation3DRobustEstimator extends EuclideanTransformation3DRobustEstimator {
     ...
     */
    public MSACEuclideanTransformation3DRobustEstimator(final boolean weakMinimumSizeAllowed) {
        ...
        final var innerEstimator = new MSACRobustEstimator<>(
                new MSACRobustEstimatorListener<EuclideanTransformation3D>() {
                    ...
                    public void onEstimateStart(final RobustEstimator<EuclideanTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateStart(MSACEuclideanTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(final RobustEstimator<EuclideanTransformation3D> estimator) {
                        if (listener != null) {
                            listener.onEstimateEnd(MSACEuclideanTransformation3DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(
                        ...
                        if (listener != null) {
                            listener.onEstimateNextIteration(
                                    MSACEuclideanTransformation3DRobustEstimator.this, iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(
                        ...
                        if (listener != null) {
                            listener.onEstimateProgressChange(
                                    MSACEuclideanTransformation3DRobustEstimator.this, progress);
                        }
                    }
                });
