...
public interface QuadricRobustEstimatorListener {
     ...
     */
    void onEstimateStart(QuadricRobustEstimator estimator);
    
    /**
     * Called when estimation ends.
     * @param estimator reference to robust estimator.
     */
    void onEstimateEnd(QuadricRobustEstimator estimator);
     ...
     */
    void onEstimateNextIteration(QuadricRobustEstimator estimator,
            int iteration);
     ...
     * and 1.0.
     */
    void onEstimateProgressChange(QuadricRobustEstimator estimator,
            float progress);
}
