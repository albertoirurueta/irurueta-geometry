 ...
 * com.irurueta.geometry.estimators.RANSACConicRobustEstimator
 * 
...
public class RANSACConicRobustEstimator extends ConicRobustEstimator{
    ...
    public Conic estimate() throws LockedException, NotReadyException, 
        ...
        RANSACRobustEstimator<Conic> innerEstimator =
                new RANSACRobustEstimator<Conic>(new RANSACRobustEstimatorListener<Conic>(){
            ...
            public void onEstimateStart(RobustEstimator<Conic> estimator) {
                if(mListener != null){
                    mListener.onEstimateStart(RANSACConicRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(RobustEstimator<Conic> estimator) {
                if(mListener != null){
                    mListener.onEstimateEnd(RANSACConicRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(
                ...
                if(mListener != null){
                    mListener.onEstimateNextIteration(
                            RANSACConicRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(
                ...
                if(mListener != null){
                    mListener.onEstimateProgressChange(
                            RANSACConicRobustEstimator.this, progress);
                }
            }
        });
