...
public class RANSACPoint3DRobustEstimator extends Point3DRobustEstimator {
     ...
     *                                  a size greater or equal than MINIMUM_SIZE.
     */
    public RANSACPoint3DRobustEstimator(final Point3DRobustEstimatorListener listener, final List<Plane> planes) {
    ...
    public Point3D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new RANSACRobustEstimator<>(new RANSACRobustEstimatorListener<Point3D>() {
            ...
            public void onEstimateStart(final RobustEstimator<Point3D> estimator) {
                if (listener != null) {
                    listener.onEstimateStart(RANSACPoint3DRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(final RobustEstimator<Point3D> estimator) {
                if (listener != null) {
                    listener.onEstimateEnd(RANSACPoint3DRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(final RobustEstimator<Point3D> estimator, final int iteration) {
                if (listener != null) {
                    listener.onEstimateNextIteration(RANSACPoint3DRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(final RobustEstimator<Point3D> estimator, final float progress) {
                if (listener != null) {
                    listener.onEstimateProgressChange(RANSACPoint3DRobustEstimator.this, progress);
                }
            }
        });
