...
public interface Point2DRobustEstimatorListener {
     ...
     */
    void onEstimateStart(Point2DRobustEstimator estimator);
    
    /**
     * Called when estimation ends.
     * @param estimator reference to robust estimator.
     */
    void onEstimateEnd(Point2DRobustEstimator estimator);
     ...
     */
    void onEstimateNextIteration(Point2DRobustEstimator estimator,
            int iteration);
     ...
     * and 1.0.
     */
    void onEstimateProgressChange(Point2DRobustEstimator estimator,
            float progress);    
}
