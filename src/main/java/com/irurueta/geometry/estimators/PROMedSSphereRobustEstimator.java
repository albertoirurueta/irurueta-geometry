...
/**
 * Finds the best sphere for provided collection of 3D points using PROMedS
 * algorithm
 */
public class PROMedSSphereRobustEstimator extends SphereRobustEstimator{
     ...
     */
    public PROMedSSphereRobustEstimator(List<Point3D> points) 
     ...
     */
    public PROMedSSphereRobustEstimator(SphereRobustEstimatorListener listener){
        super(listener);
        mStopThreshold = DEFAULT_STOP_THRESHOLD;
    }
     ...
     */
    public PROMedSSphereRobustEstimator(double[] qualityScores)
            throws IllegalArgumentException{
        super();
        mStopThreshold = DEFAULT_STOP_THRESHOLD;
    ...
    public Sphere estimate() throws LockedException, NotReadyException, 
        ...
        PROMedSRobustEstimator<Sphere> innerEstimator =
                new PROMedSRobustEstimator<Sphere>(
