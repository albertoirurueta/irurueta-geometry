 ...
 */
public class RANSACMetricTransformation2DRobustEstimator extends MetricTransformation2DRobustEstimator {
     ...
     */
    public RANSACMetricTransformation2DRobustEstimator(final MetricTransformation2DRobustEstimatorListener listener) {
        super(listener);
        threshold = DEFAULT_THRESHOLD;
        computeAndKeepInliers = DEFAULT_COMPUTE_AND_KEEP_INLIERS;
        computeAndKeepResiduals = DEFAULT_COMPUTE_AND_KEEP_RESIDUALS;
     ...
     */
    public RANSACMetricTransformation2DRobustEstimator(final boolean weakMinimumSizeAllowed) {
        ...
        final var innerEstimator = new RANSACRobustEstimator<>(
                new RANSACRobustEstimatorListener<MetricTransformation2D>() {
                    ...
                    public boolean isReady() {
                        return RANSACMetricTransformation2DRobustEstimator.this.isReady();
                    }

                    @Override
                    public void onEstimateStart(final RobustEstimator<MetricTransformation2D> estimator) {
                        if (listener != null) {
                            listener.onEstimateStart(RANSACMetricTransformation2DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(final RobustEstimator<MetricTransformation2D> estimator) {
                        if (listener != null) {
                            listener.onEstimateEnd(RANSACMetricTransformation2DRobustEstimator.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(
                        ...
                        if (listener != null) {
                            listener.onEstimateNextIteration(
                                    RANSACMetricTransformation2DRobustEstimator.this, iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(
                        ...
                        if (listener != null) {
                            listener.onEstimateProgressChange(
                                    RANSACMetricTransformation2DRobustEstimator.this, progress);
                        }
                    }
                });
