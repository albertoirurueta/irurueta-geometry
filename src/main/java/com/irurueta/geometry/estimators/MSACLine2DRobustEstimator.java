...
public class MSACLine2DRobustEstimator extends Line2DRobustEstimator {
     ...
     */
    public MSACLine2DRobustEstimator(final List<Point2D> points) {
        super(points);
        threshold = DEFAULT_THRESHOLD;
    }
     ...
     */
    public MSACLine2DRobustEstimator(final Line2DRobustEstimatorListener listener) {
        super(listener);
        threshold = DEFAULT_THRESHOLD;
    }
    ...
    public Line2D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new MSACRobustEstimator<>(new MSACRobustEstimatorListener<Line2D>() {
            ...
            public void onEstimateStart(final RobustEstimator<Line2D> estimator) {
                if (listener != null) {
                    listener.onEstimateStart(MSACLine2DRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(final RobustEstimator<Line2D> estimator) {
                if (listener != null) {
                    listener.onEstimateEnd(MSACLine2DRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(final RobustEstimator<Line2D> estimator, final int iteration) {
                if (listener != null) {
                    listener.onEstimateNextIteration(MSACLine2DRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(final RobustEstimator<Line2D> estimator, final float progress) {
                if (listener != null) {
                    listener.onEstimateProgressChange(MSACLine2DRobustEstimator.this, progress);
                }
            }
        });
