...
public class PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator extends
     ...
     */
    public PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator(final double[] qualityScores) {
        super();
        threshold = DEFAULT_THRESHOLD;
        computeAndKeepInliers = DEFAULT_COMPUTE_AND_KEEP_INLIERS;
        computeAndKeepResiduals = DEFAULT_COMPUTE_AND_KEEP_RESIDUALS;
     ...
     */
    public PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator(final PinholeCameraIntrinsicParameters intrinsic) {
        super(intrinsic);
        threshold = DEFAULT_THRESHOLD;
        computeAndKeepInliers = DEFAULT_COMPUTE_AND_KEEP_INLIERS;
        computeAndKeepResiduals = DEFAULT_COMPUTE_AND_KEEP_RESIDUALS;
    ...
    public PinholeCamera estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new PROSACRobustEstimator<>(new PROSACRobustEstimatorListener<PinholeCamera>() {
            ...
            @Override
            public boolean isReady() {
                return PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator.this.isReady();
            }

            @Override
            public void onEstimateStart(final RobustEstimator<PinholeCamera> estimator) {
                if (listener != null) {
                    listener.onEstimateStart(PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(final RobustEstimator<PinholeCamera> estimator) {
                if (listener != null) {
                    listener.onEstimateEnd(PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(final RobustEstimator<PinholeCamera> estimator, final int iteration) {
                if (listener != null) {
                    listener.onEstimateNextIteration(
                            PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(final RobustEstimator<PinholeCamera> estimator, final float progress) {
                if (listener != null) {
                    listener.onEstimateProgressChange(
                            PROSACEPnPPointCorrespondencePinholeCameraRobustEstimator.this, progress);
                }
            }
