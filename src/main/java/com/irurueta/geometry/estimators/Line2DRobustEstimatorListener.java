...
public interface Line2DRobustEstimatorListener {
   /**
     ...
     */
    void onEstimateStart(Line2DRobustEstimator estimator);
    
    /**
     * Called when estimation ends.
     * @param estimator reference to robust estimator.
     */
    void onEstimateEnd(Line2DRobustEstimator estimator);
     ...
     */
    void onEstimateNextIteration(Line2DRobustEstimator estimator,
            int iteration);
