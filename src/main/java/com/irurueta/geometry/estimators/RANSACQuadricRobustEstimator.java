...
public class RANSACQuadricRobustEstimator extends QuadricRobustEstimator{
     ...
     */
    public RANSACQuadricRobustEstimator(List<Point3D> points) 
     ...
     * a size greater or equal than MINIMUM_SIZE
     */
    public RANSACQuadricRobustEstimator(QuadricRobustEstimatorListener listener,
    ...
    public Quadric estimate() throws LockedException, NotReadyException, 
        ...
        RANSACRobustEstimator<Quadric> innerEstimator =
                new RANSACRobustEstimator<Quadric>(
