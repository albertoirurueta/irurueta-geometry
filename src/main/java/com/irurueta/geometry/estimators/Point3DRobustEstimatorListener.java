...
public interface Point3DRobustEstimatorListener {
     ...
     */
    void onEstimateStart(Point3DRobustEstimator estimator);
    
    /**
     * Called when estimation ends.
     * @param estimator reference to robust estimator.
     */
    void onEstimateEnd(Point3DRobustEstimator estimator);
     ...
     */
    void onEstimateNextIteration(Point3DRobustEstimator estimator,
            int iteration);
     ...
     * and 1.0.
     */
    void onEstimateProgressChange(Point3DRobustEstimator estimator,
            float progress);        
}
