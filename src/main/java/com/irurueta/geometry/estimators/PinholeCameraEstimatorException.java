...
public class PinholeCameraEstimatorException extends GeometryEstimatorException {
     ...
     */
    public PinholeCameraEstimatorException(final String message) {
        super(message);
    }
     ...
     */
    public PinholeCameraEstimatorException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause Instance containing the cause of the exception.
     */
    public PinholeCameraEstimatorException(final Throwable cause) {
        super(cause);
    }
}
