...
/**
 * Finds the best dual conic for provided collection of 2D lines using RANSAC
 * algorithm
 */
public class RANSACDualConicRobustEstimator extends DualConicRobustEstimator{
    /**
    ...
    public DualConic estimate() throws LockedException, NotReadyException, 
        ...
        RANSACRobustEstimator<DualConic> innerEstimator =
                new RANSACRobustEstimator<DualConic>(
