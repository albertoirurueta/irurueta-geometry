...
public class PROMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator
     ...
     */
    public PROMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator(final double[] qualityScores) {
        super();
        stopThreshold = DEFAULT_STOP_THRESHOLD;
    ...
    public ProjectiveTransformation3D estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new PROMedSRobustEstimator<>(
                new PROMedSRobustEstimatorListener<ProjectiveTransformation3D>() {
                    ...
                    @Override
                    public boolean isReady() {
                        return PROMedSPointCorrespondenceProjectiveTransformation3DRobustEstimator.this.isReady();
                    }
