...
public class AffineParameters2D implements Serializable {
     ...
     */
    public AffineParameters2D(final double scale) {
        scaleX = scaleY = scale;
        skewness = DEFAULT_SKEWNESS;
    }
     ...
     */
    public AffineParameters2D(final double scale, final double skewness) {
        scaleX = scaleY = scale;
     ...
     * @param skewness Skewness to be set.
     */
    public AffineParameters2D(final double scaleX, final double scaleY, final double skewness) {
        this.scaleX = scaleX;
        this.scaleY = scaleY;
        this.skewness = skewness;
    }
     ...
     */
    public AffineParameters2D(final Matrix m, final double threshold) {
     ...
     */
    public AffineParameters2D(final Matrix m) {
        fromMatrix(m);
    }
