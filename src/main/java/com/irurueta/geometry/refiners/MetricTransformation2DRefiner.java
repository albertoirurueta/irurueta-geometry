...
public class MetricTransformation2DRefiner extends
     ...
     */
    public MetricTransformation2DRefiner(
            MetricTransformation2D initialEstimation, boolean keepCovariance,
     ...
     */    
    @Override
    public boolean refine(MetricTransformation2D result) 
        ...
        try {
            ...
            LevenbergMarquardtMultiDimensionFunctionEvaluator evaluator =
                ...
                private MetricTransformation2D mTransformation = 
     ...
     * @return residual.
     */
    private double residual (MetricTransformation2D transformation, 
     ...
     */
    private double totalResidual(MetricTransformation2D transformation) {
        double result = 0.0;
