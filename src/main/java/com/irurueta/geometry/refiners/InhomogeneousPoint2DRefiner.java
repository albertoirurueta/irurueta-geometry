...
public class InhomogeneousPoint2DRefiner extends 
     ...
     */
    public InhomogeneousPoint2DRefiner(InhomogeneousPoint2D initialEstimation,
     ...
     */
    @Override
    public boolean refine(InhomogeneousPoint2D result) throws NotReadyException,
            LockedException, RefinerException {
        if (isLocked()) {
        ...
        try {
            ...
            LevenbergMarquardtMultiDimensionFunctionEvaluator evaluator =
                ...
                private InhomogeneousPoint2D mPoint =
