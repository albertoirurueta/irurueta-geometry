...
public class EuclideanTransformation3DRefiner extends
     ...
     */
    @Override
    public boolean refine(final EuclideanTransformation3D result)
        ...
        try {
            ...
            final LevenbergMarquardtMultiDimensionFunctionEvaluator evaluator =
                    new LevenbergMarquardtMultiDimensionFunctionEvaluator() {
                        ...
                        private final EuclideanTransformation3D mTransformation =
     ...
     * @return residual.
     */
    private double residual(final EuclideanTransformation3D transformation,
