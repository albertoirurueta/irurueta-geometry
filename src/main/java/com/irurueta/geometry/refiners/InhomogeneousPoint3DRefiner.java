...
public class InhomogeneousPoint3DRefiner extends Point3DRefiner<InhomogeneousPoint3D> {
     ...
     */
    public InhomogeneousPoint3DRefiner(
            final InhomogeneousPoint3D initialEstimation, final boolean keepCovariance, final BitSet inliers,
     ...
     */
    public InhomogeneousPoint3DRefiner(
            final InhomogeneousPoint3D initialEstimation, final boolean keepCovariance, final InliersData inliersData,
     ...
     */
    @Override
    public InhomogeneousPoint3D refine() throws NotReadyException, LockedException, RefinerException {
     ...
     */
    @Override
    public boolean refine(final InhomogeneousPoint3D result) throws NotReadyException, LockedException,
            RefinerException {
        if (isLocked()) {
        ...
        try {
            ...
            final var evaluator = new LevenbergMarquardtMultiDimensionFunctionEvaluator() {
                ...
                private final InhomogeneousPoint3D point = new InhomogeneousPoint3D();
