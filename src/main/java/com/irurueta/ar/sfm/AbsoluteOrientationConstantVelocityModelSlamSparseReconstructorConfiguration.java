...
public class AbsoluteOrientationConstantVelocityModelSlamSparseReconstructorConfiguration
        extends BaseSlamSparseReconstructorConfiguration<AbsoluteOrientationConstantVelocityModelSlamCalibrationData,
        AbsoluteOrientationConstantVelocityModelSlamSparseReconstructorConfiguration> implements Serializable {
     ...
     */
    public static AbsoluteOrientationConstantVelocityModelSlamSparseReconstructorConfiguration make() {
        return new AbsoluteOrientationConstantVelocityModelSlamSparseReconstructorConfiguration();
    }
}
