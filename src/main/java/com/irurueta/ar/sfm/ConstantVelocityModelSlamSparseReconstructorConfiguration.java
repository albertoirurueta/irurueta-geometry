...
/**
 * Contains configuration for a two view sparse reconstructor using SLAM (Simultaneous
 ...
 */
public class ConstantVelocityModelSlamSparseReconstructorConfiguration extends
        BaseSlamSparseReconstructorConfiguration<ConstantVelocityModelSlamCalibrationData,
    ...
    public static ConstantVelocityModelSlamSparseReconstructorConfiguration make() {
        return new ConstantVelocityModelSlamSparseReconstructorConfiguration();
    }
}
